...
[k8s.KubeControllerRevisionList](#opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionlist)|ControllerRevisionList is a resource containing a list of ControllerRevision objects.
...
[k8s.KubeEventListV1Beta1](#opencdk8s-cdk8s-argo-rollout-k8s-kubeeventlistv1beta1)|EventList is a list of Event objects.
...
[k8s.KubeNetworkPolicyV1Beta1](#opencdk8s-cdk8s-argo-rollout-k8s-kubenetworkpolicyv1beta1)|DEPRECATED 1.9 - This group version of NetworkPolicy is deprecated by networking/v1/NetworkPolicy. NetworkPolicy describes what network traffic is allowed for a set of Pods.
...
[k8s.KubeReplicationController](#opencdk8s-cdk8s-argo-rollout-k8s-kubereplicationcontroller)|ReplicationController represents the configuration of a replication controller.
...
[k8s.KubeServiceAccount](#opencdk8s-cdk8s-argo-rollout-k8s-kubeserviceaccount)|ServiceAccount binds together: * a name, understood by users, and perhaps by peripheral systems, for an identity * a principal that can be authenticated and authorized * a set of secrets.
...
[k8s.Container](#opencdk8s-cdk8s-argo-rollout-k8s-container)|A single application container that you want to run within a pod.
...
[k8s.EventSeries](#opencdk8s-cdk8s-argo-rollout-k8s-eventseries)|EventSeries contain information on series of events, i.e. thing that was/is happening continuously for some time.
...
[k8s.IscsiPersistentVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-iscsipersistentvolumesource)|ISCSIPersistentVolumeSource represents an ISCSI disk.
...
[k8s.KubeConfigMapProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeconfigmapprops)|ConfigMap holds configuration data for pods to consume.
...
[k8s.KubeDeploymentV1Beta2Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentv1beta2props)|DEPRECATED - This group version of Deployment is deprecated by apps/v1/Deployment.
...
[k8s.KubeMutatingWebhookConfigurationV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubemutatingwebhookconfigurationv1beta1props)|MutatingWebhookConfiguration describes the configuration of and admission webhook that accept or reject and may change the object.
...
[k8s.KubePriorityClassV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclassv1beta1props)|DEPRECATED - This group version of PriorityClass is deprecated by scheduling.k8s.io/v1/PriorityClass. PriorityClass defines mapping from a priority class name to the priority integer value. The value can be any valid integer.
...
[k8s.KubeSecretProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubesecretprops)|Secret holds secret data of a certain type.
...
[k8s.KubeVolumeAttachmentListV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentlistv1alpha1props)|VolumeAttachmentList is a collection of VolumeAttachment objects.
...
[k8s.NodeSelectorRequirement](#opencdk8s-cdk8s-argo-rollout-k8s-nodeselectorrequirement)|A node selector requirement is a selector that contains values, a key, and an operator that relates the key and values.
...
[k8s.PortworxVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-portworxvolumesource)|PortworxVolumeSource represents a Portworx volume resource.
...
[k8s.ScopeSelector](#opencdk8s-cdk8s-argo-rollout-k8s-scopeselector)|A scope selector represents the AND of the selectors represented by the scoped-resource selector requirements.
...
[k8s.Toleration](#opencdk8s-cdk8s-argo-rollout-k8s-toleration)|The pod this Toleration is attached to tolerates any taint that matches the triple <key,value,effect> using the matching operator <operator>.
...
[k8s.VolumeProjection](#opencdk8s-cdk8s-argo-rollout-k8s-volumeprojection)|Projection that may be projected along with other supported volume types.
[k8s.VsphereVirtualDiskVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-vspherevirtualdiskvolumesource)|Represents a vSphere volume resource.
[k8s.Webhook](#opencdk8s-cdk8s-argo-rollout-k8s-webhook)|Webhook holds the configuration of the webhook.
[k8s.WebhookClientConfig](#opencdk8s-cdk8s-argo-rollout-k8s-webhookclientconfig)|WebhookClientConfig contains the information to make a TLS connection with the webhook.
[k8s.WebhookThrottleConfig](#opencdk8s-cdk8s-argo-rollout-k8s-webhookthrottleconfig)|WebhookThrottleConfig holds the configuration for throttling events.
[k8s.WeightedPodAffinityTerm](#opencdk8s-cdk8s-argo-rollout-k8s-weightedpodaffinityterm)|The weights of all of the matched WeightedPodAffinityTerm fields are added per-node to find the most preferred node(s).
[k8s.WindowsSecurityContextOptions](#opencdk8s-cdk8s-argo-rollout-k8s-windowssecuritycontextoptions)|WindowsSecurityContextOptions contain Windows-specific options and credentials.
...
Name|Description
----|-----------
[k8s.IoK8SApimachineryPkgApisMetaV1DeleteOptionsKind](#opencdk8s-cdk8s-argo-rollout-k8s-iok8sapimachinerypkgapismetav1deleteoptionskind)|Kind is a string value representing the REST resource this object represents.



## class ArgoRollout 🔹 <a id="opencdk8s-cdk8s-argo-rollout-argorollout"></a>
...
```ts
new ArgoRollout(scope: Construct, id: string, props: ArgoRolloutProps)
```
...
* **props** (<code>[ArgoRolloutProps](#opencdk8s-cdk8s-argo-rollout-argorolloutprops)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **spec** (<code>[ArgoSpecs](#opencdk8s-cdk8s-argo-rollout-argospecs)</code>)  Spec defines the behavior of the ingress. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-argorollout-manifest"></a>
...
## class IntOrString 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-intorstring"></a>
...
#### *static* fromNumber(value)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-intorstring-fromnumber"></a>
...
__Returns__:
* <code>[k8s.IntOrString](#opencdk8s-cdk8s-argo-rollout-k8s-intorstring)</code>

#### *static* fromString(value)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-intorstring-fromstring"></a>
...
## class KubeApiService 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeapiservice"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeApiServiceProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeapiserviceprops)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  *No description* __*Optional*__
  * **spec** (<code>[k8s.ApiServiceSpec](#opencdk8s-cdk8s-argo-rollout-k8s-apiservicespec)</code>)  Spec contains information for locating and communicating with a server. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeapiservice-manifest"></a>
...
## class KubeApiServiceList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeapiservicelist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeApiServiceListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeapiservicelistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeApiServiceProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeapiserviceprops)></code>)  *No description* 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  *No description* __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeapiservicelist-manifest"></a>
...
## class KubeApiServiceListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeapiservicelistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeApiServiceListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeapiservicelistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeApiServiceV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeapiservicev1beta1props)></code>)  *No description* 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  *No description* __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeapiservicelistv1beta1-manifest"></a>
...
## class KubeApiServiceV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeapiservicev1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeApiServiceV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeapiservicev1beta1props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  *No description* __*Optional*__
  * **spec** (<code>[k8s.ApiServiceSpec](#opencdk8s-cdk8s-argo-rollout-k8s-apiservicespec)</code>)  Spec contains information for locating and communicating with a server. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeapiservicev1beta1-manifest"></a>
...
## class KubeAuditSinkListV1Alpha1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeauditsinklistv1alpha1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeAuditSinkListV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeauditsinklistv1alpha1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeAuditSinkV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeauditsinkv1alpha1props)></code>)  List of audit configurations. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  *No description* __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeauditsinklistv1alpha1-manifest"></a>
...
## class KubeAuditSinkV1Alpha1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeauditsinkv1alpha1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeAuditSinkV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeauditsinkv1alpha1props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  *No description* __*Optional*__
  * **spec** (<code>[k8s.AuditSinkSpec](#opencdk8s-cdk8s-argo-rollout-k8s-auditsinkspec)</code>)  Spec defines the audit configuration spec. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeauditsinkv1alpha1-manifest"></a>
...
## class KubeBinding 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubebinding"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeBindingProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubebindingprops)</code>)  initialization props.
  * **target** (<code>[k8s.ObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-objectreference)</code>)  The target object that you want to bind to the standard object. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubebinding-manifest"></a>
...
## class KubeCertificateSigningRequestListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecertificatesigningrequestlistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeCertificateSigningRequestListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecertificatesigningrequestlistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeCertificateSigningRequestV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecertificatesigningrequestv1beta1props)></code>)  *No description* 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  *No description* __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecertificatesigningrequestlistv1beta1-manifest"></a>
...
## class KubeCertificateSigningRequestV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecertificatesigningrequestv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeCertificateSigningRequestV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecertificatesigningrequestv1beta1props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  *No description* __*Optional*__
  * **spec** (<code>[k8s.CertificateSigningRequestSpec](#opencdk8s-cdk8s-argo-rollout-k8s-certificatesigningrequestspec)</code>)  The certificate request itself and any additional information. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecertificatesigningrequestv1beta1-manifest"></a>
...
## class KubeClusterRole 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrole"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeClusterRoleProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterroleprops)</code>)  initialization props.
  * **aggregationRule** (<code>[k8s.AggregationRule](#opencdk8s-cdk8s-argo-rollout-k8s-aggregationrule)</code>)  AggregationRule is an optional field that describes how to build the Rules for this ClusterRole. __*Optional*__
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **rules** (<code>Array<[k8s.PolicyRule](#opencdk8s-cdk8s-argo-rollout-k8s-policyrule)></code>)  Rules holds all the PolicyRules for this ClusterRole. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrole-manifest"></a>
...
## class KubeClusterRoleBinding 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebinding"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeClusterRoleBindingProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindingprops)</code>)  initialization props.
  * **roleRef** (<code>[k8s.RoleRef](#opencdk8s-cdk8s-argo-rollout-k8s-roleref)</code>)  RoleRef can only reference a ClusterRole in the global namespace. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **subjects** (<code>Array<[k8s.Subject](#opencdk8s-cdk8s-argo-rollout-k8s-subject)></code>)  Subjects holds references to the objects the role applies to. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebinding-manifest"></a>
...
## class KubeClusterRoleBindingList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindinglist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeClusterRoleBindingListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindinglistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeClusterRoleBindingProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindingprops)></code>)  Items is a list of ClusterRoleBindings. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard object's metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindinglist-manifest"></a>
...
## class KubeClusterRoleBindingListV1Alpha1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindinglistv1alpha1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeClusterRoleBindingListV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindinglistv1alpha1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeClusterRoleBindingV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindingv1alpha1props)></code>)  Items is a list of ClusterRoleBindings. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard object's metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindinglistv1alpha1-manifest"></a>
...
## class KubeClusterRoleBindingListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindinglistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeClusterRoleBindingListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindinglistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeClusterRoleBindingV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindingv1beta1props)></code>)  Items is a list of ClusterRoleBindings. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard object's metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindinglistv1beta1-manifest"></a>
...
## class KubeClusterRoleBindingV1Alpha1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindingv1alpha1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeClusterRoleBindingV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindingv1alpha1props)</code>)  initialization props.
  * **roleRef** (<code>[k8s.RoleRef](#opencdk8s-cdk8s-argo-rollout-k8s-roleref)</code>)  RoleRef can only reference a ClusterRole in the global namespace. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **subjects** (<code>Array<[k8s.Subject](#opencdk8s-cdk8s-argo-rollout-k8s-subject)></code>)  Subjects holds references to the objects the role applies to. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindingv1alpha1-manifest"></a>
...
## class KubeClusterRoleBindingV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindingv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeClusterRoleBindingV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindingv1beta1props)</code>)  initialization props.
  * **roleRef** (<code>[k8s.RoleRef](#opencdk8s-cdk8s-argo-rollout-k8s-roleref)</code>)  RoleRef can only reference a ClusterRole in the global namespace. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **subjects** (<code>Array<[k8s.Subject](#opencdk8s-cdk8s-argo-rollout-k8s-subject)></code>)  Subjects holds references to the objects the role applies to. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindingv1beta1-manifest"></a>
...
## class KubeClusterRoleList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolelist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeClusterRoleListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolelistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeClusterRoleProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterroleprops)></code>)  Items is a list of ClusterRoles. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard object's metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolelist-manifest"></a>
...
## class KubeClusterRoleListV1Alpha1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolelistv1alpha1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeClusterRoleListV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolelistv1alpha1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeClusterRoleV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolev1alpha1props)></code>)  Items is a list of ClusterRoles. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard object's metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolelistv1alpha1-manifest"></a>
...
## class KubeClusterRoleListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolelistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeClusterRoleListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolelistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeClusterRoleV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolev1beta1props)></code>)  Items is a list of ClusterRoles. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard object's metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolelistv1beta1-manifest"></a>
...
## class KubeClusterRoleV1Alpha1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolev1alpha1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeClusterRoleV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolev1alpha1props)</code>)  initialization props.
  * **aggregationRule** (<code>[k8s.AggregationRule](#opencdk8s-cdk8s-argo-rollout-k8s-aggregationrule)</code>)  AggregationRule is an optional field that describes how to build the Rules for this ClusterRole. __*Optional*__
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **rules** (<code>Array<[k8s.PolicyRule](#opencdk8s-cdk8s-argo-rollout-k8s-policyrule)></code>)  Rules holds all the PolicyRules for this ClusterRole. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolev1alpha1-manifest"></a>
...
## class KubeClusterRoleV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolev1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeClusterRoleV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolev1beta1props)</code>)  initialization props.
  * **aggregationRule** (<code>[k8s.AggregationRule](#opencdk8s-cdk8s-argo-rollout-k8s-aggregationrule)</code>)  AggregationRule is an optional field that describes how to build the Rules for this ClusterRole. __*Optional*__
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **rules** (<code>Array<[k8s.PolicyRule](#opencdk8s-cdk8s-argo-rollout-k8s-policyrule)></code>)  Rules holds all the PolicyRules for this ClusterRole. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolev1beta1-manifest"></a>
...
## class KubeComponentStatus 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecomponentstatus"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeComponentStatusProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubecomponentstatusprops)</code>)  initialization props.
  * **conditions** (<code>Array<[k8s.ComponentCondition](#opencdk8s-cdk8s-argo-rollout-k8s-componentcondition)></code>)  List of component conditions observed. __*Optional*__
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecomponentstatus-manifest"></a>
...
## class KubeComponentStatusList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecomponentstatuslist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeComponentStatusListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubecomponentstatuslistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeComponentStatusProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubecomponentstatusprops)></code>)  List of ComponentStatus objects. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecomponentstatuslist-manifest"></a>
...
## class KubeConfigMap 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeconfigmap"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeConfigMapProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeconfigmapprops)</code>)  initialization props.
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeconfigmap-manifest"></a>
...
## class KubeConfigMapList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeconfigmaplist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeConfigMapListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeconfigmaplistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeConfigMapProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeconfigmapprops)></code>)  Items is the list of ConfigMaps. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeconfigmaplist-manifest"></a>
...
## class KubeControllerRevision 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevision"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeControllerRevisionProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionprops)</code>)  initialization props.
  * **revision** (<code>number</code>)  Revision indicates the revision of the state represented by Data. 
  * **data** (<code>[k8s.RawExtension](#opencdk8s-cdk8s-argo-rollout-k8s-rawextension)</code>)  Data is the serialized representation of the state. __*Optional*__
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevision-manifest"></a>
...
## class KubeControllerRevisionList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionlist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeControllerRevisionListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionlistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeControllerRevisionProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionprops)></code>)  Items is the list of ControllerRevisions. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionlist-manifest"></a>
...
## class KubeControllerRevisionListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionlistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeControllerRevisionListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionlistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeControllerRevisionV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionv1beta1props)></code>)  Items is the list of ControllerRevisions. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionlistv1beta1-manifest"></a>
...
## class KubeControllerRevisionListV1Beta2 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionlistv1beta2"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeControllerRevisionListV1Beta2Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionlistv1beta2props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeControllerRevisionV1Beta2Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionv1beta2props)></code>)  Items is the list of ControllerRevisions. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionlistv1beta2-manifest"></a>
...
## class KubeControllerRevisionV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeControllerRevisionV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionv1beta1props)</code>)  initialization props.
  * **revision** (<code>number</code>)  Revision indicates the revision of the state represented by Data. 
  * **data** (<code>[k8s.RawExtension](#opencdk8s-cdk8s-argo-rollout-k8s-rawextension)</code>)  Data is the serialized representation of the state. __*Optional*__
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionv1beta1-manifest"></a>
...
## class KubeControllerRevisionV1Beta2 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionv1beta2"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeControllerRevisionV1Beta2Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionv1beta2props)</code>)  initialization props.
  * **revision** (<code>number</code>)  Revision indicates the revision of the state represented by Data. 
  * **data** (<code>[k8s.RawExtension](#opencdk8s-cdk8s-argo-rollout-k8s-rawextension)</code>)  Data is the serialized representation of the state. __*Optional*__
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionv1beta2-manifest"></a>
...
## class KubeCronJobListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecronjoblistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeCronJobListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecronjoblistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeCronJobV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecronjobv1beta1props)></code>)  items is the list of CronJobs. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecronjoblistv1beta1-manifest"></a>
...
## class KubeCronJobListV2Alpha1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecronjoblistv2alpha1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeCronJobListV2Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecronjoblistv2alpha1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeCronJobV2Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecronjobv2alpha1props)></code>)  items is the list of CronJobs. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecronjoblistv2alpha1-manifest"></a>
...
## class KubeCronJobV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecronjobv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeCronJobV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecronjobv1beta1props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **spec** (<code>[k8s.CronJobSpec](#opencdk8s-cdk8s-argo-rollout-k8s-cronjobspec)</code>)  Specification of the desired behavior of a cron job, including the schedule. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecronjobv1beta1-manifest"></a>
...
## class KubeCronJobV2Alpha1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecronjobv2alpha1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeCronJobV2Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecronjobv2alpha1props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **spec** (<code>[k8s.CronJobSpec](#opencdk8s-cdk8s-argo-rollout-k8s-cronjobspec)</code>)  Specification of the desired behavior of a cron job, including the schedule. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecronjobv2alpha1-manifest"></a>
...
## class KubeCsiDriverListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecsidriverlistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeCsiDriverListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecsidriverlistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeCsiDriverV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecsidriverv1beta1props)></code>)  items is the list of CSIDriver. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecsidriverlistv1beta1-manifest"></a>
...
## class KubeCsiDriverV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecsidriverv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeCsiDriverV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecsidriverv1beta1props)</code>)  initialization props.
  * **spec** (<code>[k8s.CsiDriverSpec](#opencdk8s-cdk8s-argo-rollout-k8s-csidriverspec)</code>)  Specification of the CSI Driver. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecsidriverv1beta1-manifest"></a>
...
## class KubeCsiNodeListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecsinodelistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeCsiNodeListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecsinodelistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeCsiNodeV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecsinodev1beta1props)></code>)  items is the list of CSINode. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecsinodelistv1beta1-manifest"></a>
...
## class KubeCsiNodeV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecsinodev1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeCsiNodeV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecsinodev1beta1props)</code>)  initialization props.
  * **spec** (<code>[k8s.CsiNodeSpec](#opencdk8s-cdk8s-argo-rollout-k8s-csinodespec)</code>)  spec is the specification of CSINode. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  metadata.name must be the Kubernetes node name. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecsinodev1beta1-manifest"></a>
...
## class KubeCustomResourceDefinitionListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecustomresourcedefinitionlistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeCustomResourceDefinitionListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecustomresourcedefinitionlistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeCustomResourceDefinitionV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecustomresourcedefinitionv1beta1props)></code>)  Items individual CustomResourceDefinitions. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  *No description* __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecustomresourcedefinitionlistv1beta1-manifest"></a>
...
## class KubeCustomResourceDefinitionV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecustomresourcedefinitionv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeCustomResourceDefinitionV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecustomresourcedefinitionv1beta1props)</code>)  initialization props.
  * **spec** (<code>[k8s.CustomResourceDefinitionSpec](#opencdk8s-cdk8s-argo-rollout-k8s-customresourcedefinitionspec)</code>)  Spec describes how the user wants the resources to appear. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  *No description* __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecustomresourcedefinitionv1beta1-manifest"></a>
...
## class KubeDaemonSet 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonset"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeDaemonSetProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetprops)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **spec** (<code>[k8s.DaemonSetSpec](#opencdk8s-cdk8s-argo-rollout-k8s-daemonsetspec)</code>)  The desired behavior of this daemon set. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonset-manifest"></a>
...
## class KubeDaemonSetList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetlist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeDaemonSetListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetlistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeDaemonSetProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetprops)></code>)  A list of daemon sets. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetlist-manifest"></a>
...
## class KubeDaemonSetListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetlistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeDaemonSetListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetlistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeDaemonSetV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetv1beta1props)></code>)  A list of daemon sets. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetlistv1beta1-manifest"></a>
...
## class KubeDaemonSetListV1Beta2 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetlistv1beta2"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeDaemonSetListV1Beta2Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetlistv1beta2props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeDaemonSetV1Beta2Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetv1beta2props)></code>)  A list of daemon sets. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetlistv1beta2-manifest"></a>
...
## class KubeDaemonSetV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeDaemonSetV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetv1beta1props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **spec** (<code>[k8s.DaemonSetSpec](#opencdk8s-cdk8s-argo-rollout-k8s-daemonsetspec)</code>)  The desired behavior of this daemon set. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetv1beta1-manifest"></a>
...
## class KubeDaemonSetV1Beta2 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetv1beta2"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeDaemonSetV1Beta2Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetv1beta2props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **spec** (<code>[k8s.DaemonSetSpec](#opencdk8s-cdk8s-argo-rollout-k8s-daemonsetspec)</code>)  The desired behavior of this daemon set. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetv1beta2-manifest"></a>
...
## class KubeDeployment 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedeployment"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeDeploymentProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentprops)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object metadata. __*Optional*__
  * **spec** (<code>[k8s.DeploymentSpec](#opencdk8s-cdk8s-argo-rollout-k8s-deploymentspec)</code>)  Specification of the desired behavior of the Deployment. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedeployment-manifest"></a>
...
## class KubeDeploymentList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentlist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeDeploymentListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentlistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeDeploymentProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentprops)></code>)  Items is the list of Deployments. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentlist-manifest"></a>
...
## class KubeDeploymentListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentlistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeDeploymentListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentlistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeDeploymentV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentv1beta1props)></code>)  Items is the list of Deployments. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentlistv1beta1-manifest"></a>
...
## class KubeDeploymentListV1Beta2 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentlistv1beta2"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeDeploymentListV1Beta2Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentlistv1beta2props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeDeploymentV1Beta2Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentv1beta2props)></code>)  Items is the list of Deployments. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentlistv1beta2-manifest"></a>
...
## class KubeDeploymentV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeDeploymentV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentv1beta1props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object metadata. __*Optional*__
  * **spec** (<code>[k8s.DeploymentSpec](#opencdk8s-cdk8s-argo-rollout-k8s-deploymentspec)</code>)  Specification of the desired behavior of the Deployment. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentv1beta1-manifest"></a>
...
## class KubeDeploymentV1Beta2 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentv1beta2"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeDeploymentV1Beta2Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentv1beta2props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object metadata. __*Optional*__
  * **spec** (<code>[k8s.DeploymentSpec](#opencdk8s-cdk8s-argo-rollout-k8s-deploymentspec)</code>)  Specification of the desired behavior of the Deployment. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentv1beta2-manifest"></a>
...
## class KubeEndpoints 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeendpoints"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeEndpointsProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeendpointsprops)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **subsets** (<code>Array<[k8s.EndpointSubset](#opencdk8s-cdk8s-argo-rollout-k8s-endpointsubset)></code>)  The set of all endpoints is the union of all subsets. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeendpoints-manifest"></a>
...
## class KubeEndpointsList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeendpointslist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeEndpointsListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeendpointslistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeEndpointsProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeendpointsprops)></code>)  List of endpoints. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeendpointslist-manifest"></a>
...
## class KubeEvent 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeevent"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeEventProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeeventprops)</code>)  initialization props.
  * **involvedObject** (<code>[k8s.ObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-objectreference)</code>)  The object that this event is about. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. 
  ...
  * **related** (<code>[k8s.ObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-objectreference)</code>)  Optional secondary object for more complex actions. __*Optional*__
  ...
  * **series** (<code>[k8s.EventSeries](#opencdk8s-cdk8s-argo-rollout-k8s-eventseries)</code>)  Data about the Event series this event represents or nil if it's a singleton Event. __*Optional*__
  * **source** (<code>[k8s.EventSource](#opencdk8s-cdk8s-argo-rollout-k8s-eventsource)</code>)  The component reporting this event. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeevent-manifest"></a>
...
## class KubeEventList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeeventlist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeEventListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeeventlistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeEventProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeeventprops)></code>)  List of events. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeeventlist-manifest"></a>
...
## class KubeEventListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeeventlistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeEventListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeeventlistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeEventV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeeventv1beta1props)></code>)  Items is a list of schema objects. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeeventlistv1beta1-manifest"></a>
...
## class KubeEventV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeeventv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeEventV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeeventv1beta1props)</code>)  initialization props.
  ...
  * **deprecatedSource** (<code>[k8s.EventSource](#opencdk8s-cdk8s-argo-rollout-k8s-eventsource)</code>)  Deprecated field assuring backward compatibility with core.v1 Event type. __*Optional*__
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  *No description* __*Optional*__
  * **note** (<code>string</code>)  Optional. __*Optional*__
  * **reason** (<code>string</code>)  Why the action was taken. __*Optional*__
  * **regarding** (<code>[k8s.ObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-objectreference)</code>)  The object this Event is about. __*Optional*__
  * **related** (<code>[k8s.ObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-objectreference)</code>)  Optional secondary object for more complex actions. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeeventv1beta1-manifest"></a>
...
## class KubeEvictionV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeevictionv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeEvictionV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeevictionv1beta1props)</code>)  initialization props.
  * **deleteOptions** (<code>[k8s.DeleteOptions](#opencdk8s-cdk8s-argo-rollout-k8s-deleteoptions)</code>)  DeleteOptions may be provided. __*Optional*__
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  ObjectMeta describes the pod that is being evicted. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeevictionv1beta1-manifest"></a>
...
## class KubeHorizontalPodAutoscaler 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscaler"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeHorizontalPodAutoscalerProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerprops)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object metadata. __*Optional*__
  * **spec** (<code>[k8s.HorizontalPodAutoscalerSpec](#opencdk8s-cdk8s-argo-rollout-k8s-horizontalpodautoscalerspec)</code>)  behaviour of autoscaler. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscaler-manifest"></a>
...
## class KubeHorizontalPodAutoscalerList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerlist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeHorizontalPodAutoscalerListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerlistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeHorizontalPodAutoscalerProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerprops)></code>)  list of horizontal pod autoscaler objects. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerlist-manifest"></a>
...
## class KubeHorizontalPodAutoscalerListV2Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerlistv2beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeHorizontalPodAutoscalerListV2Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerlistv2beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeHorizontalPodAutoscalerV2Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerv2beta1props)></code>)  items is the list of horizontal pod autoscaler objects. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  metadata is the standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerlistv2beta1-manifest"></a>
...
## class KubeHorizontalPodAutoscalerListV2Beta2 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerlistv2beta2"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeHorizontalPodAutoscalerListV2Beta2Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerlistv2beta2props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeHorizontalPodAutoscalerV2Beta2Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerv2beta2props)></code>)  items is the list of horizontal pod autoscaler objects. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  metadata is the standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerlistv2beta2-manifest"></a>
...
## class KubeHorizontalPodAutoscalerV2Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerv2beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeHorizontalPodAutoscalerV2Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerv2beta1props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  metadata is the standard object metadata. __*Optional*__
  * **spec** (<code>[k8s.HorizontalPodAutoscalerSpec](#opencdk8s-cdk8s-argo-rollout-k8s-horizontalpodautoscalerspec)</code>)  spec is the specification for the behaviour of the autoscaler. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerv2beta1-manifest"></a>
...
## class KubeHorizontalPodAutoscalerV2Beta2 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerv2beta2"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeHorizontalPodAutoscalerV2Beta2Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerv2beta2props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  metadata is the standard object metadata. __*Optional*__
  * **spec** (<code>[k8s.HorizontalPodAutoscalerSpec](#opencdk8s-cdk8s-argo-rollout-k8s-horizontalpodautoscalerspec)</code>)  spec is the specification for the behaviour of the autoscaler. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerv2beta2-manifest"></a>
...
## class KubeIngressListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeingresslistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeIngressListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeingresslistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeIngressV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeingressv1beta1props)></code>)  Items is the list of Ingress. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard object's metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeingresslistv1beta1-manifest"></a>
...
## class KubeIngressV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeingressv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeIngressV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeingressv1beta1props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **spec** (<code>[k8s.IngressSpec](#opencdk8s-cdk8s-argo-rollout-k8s-ingressspec)</code>)  Spec is the desired state of the Ingress. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeingressv1beta1-manifest"></a>
...
## class KubeJob 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubejob"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeJobProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubejobprops)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **spec** (<code>[k8s.JobSpec](#opencdk8s-cdk8s-argo-rollout-k8s-jobspec)</code>)  Specification of the desired behavior of a job. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubejob-manifest"></a>
...
## class KubeJobList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubejoblist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeJobListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubejoblistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeJobProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubejobprops)></code>)  items is the list of Jobs. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubejoblist-manifest"></a>
...
## class KubeLease 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubelease"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeLeaseProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeleaseprops)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata. __*Optional*__
  * **spec** (<code>[k8s.LeaseSpec](#opencdk8s-cdk8s-argo-rollout-k8s-leasespec)</code>)  Specification of the Lease. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubelease-manifest"></a>
...
## class KubeLeaseList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeleaselist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeLeaseListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeleaselistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeLeaseProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeleaseprops)></code>)  Items is a list of schema objects. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeleaselist-manifest"></a>
...
## class KubeLeaseListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeleaselistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeLeaseListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeleaselistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeLeaseV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeleasev1beta1props)></code>)  Items is a list of schema objects. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeleaselistv1beta1-manifest"></a>
...
## class KubeLeaseV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeleasev1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeLeaseV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeleasev1beta1props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata. __*Optional*__
  * **spec** (<code>[k8s.LeaseSpec](#opencdk8s-cdk8s-argo-rollout-k8s-leasespec)</code>)  Specification of the Lease. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeleasev1beta1-manifest"></a>
...
## class KubeLimitRange 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubelimitrange"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeLimitRangeProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubelimitrangeprops)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **spec** (<code>[k8s.LimitRangeSpec](#opencdk8s-cdk8s-argo-rollout-k8s-limitrangespec)</code>)  Spec defines the limits enforced. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubelimitrange-manifest"></a>
...
## class KubeLimitRangeList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubelimitrangelist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeLimitRangeListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubelimitrangelistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeLimitRangeProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubelimitrangeprops)></code>)  Items is a list of LimitRange objects. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubelimitrangelist-manifest"></a>
...
## class KubeLocalSubjectAccessReview 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubelocalsubjectaccessreview"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeLocalSubjectAccessReviewProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubelocalsubjectaccessreviewprops)</code>)  initialization props.
  * **spec** (<code>[k8s.SubjectAccessReviewSpec](#opencdk8s-cdk8s-argo-rollout-k8s-subjectaccessreviewspec)</code>)  Spec holds information about the request being evaluated. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  *No description* __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubelocalsubjectaccessreview-manifest"></a>
...
## class KubeLocalSubjectAccessReviewV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubelocalsubjectaccessreviewv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeLocalSubjectAccessReviewV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubelocalsubjectaccessreviewv1beta1props)</code>)  initialization props.
  * **spec** (<code>[k8s.SubjectAccessReviewSpec](#opencdk8s-cdk8s-argo-rollout-k8s-subjectaccessreviewspec)</code>)  Spec holds information about the request being evaluated. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  *No description* __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubelocalsubjectaccessreviewv1beta1-manifest"></a>
...
## class KubeMutatingWebhookConfigurationListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubemutatingwebhookconfigurationlistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeMutatingWebhookConfigurationListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubemutatingwebhookconfigurationlistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeMutatingWebhookConfigurationV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubemutatingwebhookconfigurationv1beta1props)></code>)  List of MutatingWebhookConfiguration. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubemutatingwebhookconfigurationlistv1beta1-manifest"></a>
...
## class KubeMutatingWebhookConfigurationV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubemutatingwebhookconfigurationv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeMutatingWebhookConfigurationV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubemutatingwebhookconfigurationv1beta1props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object metadata; __*Optional*__
  * **webhooks** (<code>Array<[k8s.MutatingWebhook](#opencdk8s-cdk8s-argo-rollout-k8s-mutatingwebhook)></code>)  Webhooks is a list of webhooks and the affected resources and operations. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubemutatingwebhookconfigurationv1beta1-manifest"></a>
...
## class KubeNamespace 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenamespace"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeNamespaceProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubenamespaceprops)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **spec** (<code>[k8s.NamespaceSpec](#opencdk8s-cdk8s-argo-rollout-k8s-namespacespec)</code>)  Spec defines the behavior of the Namespace. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenamespace-manifest"></a>
...
## class KubeNamespaceList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenamespacelist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeNamespaceListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubenamespacelistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeNamespaceProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubenamespaceprops)></code>)  Items is the list of Namespace objects in the list. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenamespacelist-manifest"></a>
...
## class KubeNetworkPolicy 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenetworkpolicy"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeNetworkPolicyProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubenetworkpolicyprops)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **spec** (<code>[k8s.NetworkPolicySpec](#opencdk8s-cdk8s-argo-rollout-k8s-networkpolicyspec)</code>)  Specification of the desired behavior for this NetworkPolicy. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenetworkpolicy-manifest"></a>
...
## class KubeNetworkPolicyList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenetworkpolicylist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeNetworkPolicyListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubenetworkpolicylistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeNetworkPolicyProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubenetworkpolicyprops)></code>)  Items is a list of schema objects. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenetworkpolicylist-manifest"></a>
...
## class KubeNetworkPolicyListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenetworkpolicylistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeNetworkPolicyListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubenetworkpolicylistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeNetworkPolicyV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubenetworkpolicyv1beta1props)></code>)  Items is a list of schema objects. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenetworkpolicylistv1beta1-manifest"></a>
...
## class KubeNetworkPolicyV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenetworkpolicyv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeNetworkPolicyV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubenetworkpolicyv1beta1props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **spec** (<code>[k8s.NetworkPolicySpec](#opencdk8s-cdk8s-argo-rollout-k8s-networkpolicyspec)</code>)  Specification of the desired behavior for this NetworkPolicy. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenetworkpolicyv1beta1-manifest"></a>
...
## class KubeNode 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenode"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeNodeProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubenodeprops)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **spec** (<code>[k8s.NodeSpec](#opencdk8s-cdk8s-argo-rollout-k8s-nodespec)</code>)  Spec defines the behavior of a node. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenode-manifest"></a>
...
## class KubeNodeList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenodelist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeNodeListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubenodelistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeNodeProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubenodeprops)></code>)  List of nodes. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenodelist-manifest"></a>
...
## class KubePersistentVolume 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepersistentvolume"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubePersistentVolumeProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubepersistentvolumeprops)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **spec** (<code>[k8s.PersistentVolumeSpec](#opencdk8s-cdk8s-argo-rollout-k8s-persistentvolumespec)</code>)  Spec defines a specification of a persistent volume owned by the cluster. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepersistentvolume-manifest"></a>
...
## class KubePersistentVolumeClaim 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepersistentvolumeclaim"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubePersistentVolumeClaimProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubepersistentvolumeclaimprops)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **spec** (<code>[k8s.PersistentVolumeClaimSpec](#opencdk8s-cdk8s-argo-rollout-k8s-persistentvolumeclaimspec)</code>)  Spec defines the desired characteristics of a volume requested by a pod author. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepersistentvolumeclaim-manifest"></a>
...
## class KubePersistentVolumeClaimList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepersistentvolumeclaimlist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubePersistentVolumeClaimListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubepersistentvolumeclaimlistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubePersistentVolumeClaimProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubepersistentvolumeclaimprops)></code>)  A list of persistent volume claims. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepersistentvolumeclaimlist-manifest"></a>
...
## class KubePersistentVolumeList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepersistentvolumelist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubePersistentVolumeListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubepersistentvolumelistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubePersistentVolumeProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubepersistentvolumeprops)></code>)  List of persistent volumes. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepersistentvolumelist-manifest"></a>
...
## class KubePod 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepod"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubePodProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubepodprops)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **spec** (<code>[k8s.PodSpec](#opencdk8s-cdk8s-argo-rollout-k8s-podspec)</code>)  Specification of the desired behavior of the pod. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepod-manifest"></a>
...
## class KubePodDisruptionBudgetListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepoddisruptionbudgetlistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubePodDisruptionBudgetListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubepoddisruptionbudgetlistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubePodDisruptionBudgetV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubepoddisruptionbudgetv1beta1props)></code>)  *No description* 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  *No description* __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepoddisruptionbudgetlistv1beta1-manifest"></a>
...
## class KubePodDisruptionBudgetV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepoddisruptionbudgetv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubePodDisruptionBudgetV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubepoddisruptionbudgetv1beta1props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  *No description* __*Optional*__
  * **spec** (<code>[k8s.PodDisruptionBudgetSpec](#opencdk8s-cdk8s-argo-rollout-k8s-poddisruptionbudgetspec)</code>)  Specification of the desired behavior of the PodDisruptionBudget. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepoddisruptionbudgetv1beta1-manifest"></a>
...
## class KubePodList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepodlist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubePodListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubepodlistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubePodProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubepodprops)></code>)  List of pods. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepodlist-manifest"></a>
...
## class KubePodPresetListV1Alpha1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepodpresetlistv1alpha1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubePodPresetListV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubepodpresetlistv1alpha1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubePodPresetV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubepodpresetv1alpha1props)></code>)  Items is a list of schema objects. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepodpresetlistv1alpha1-manifest"></a>
...
## class KubePodPresetV1Alpha1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepodpresetv1alpha1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubePodPresetV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubepodpresetv1alpha1props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  *No description* __*Optional*__
  * **spec** (<code>[k8s.PodPresetSpec](#opencdk8s-cdk8s-argo-rollout-k8s-podpresetspec)</code>)  *No description* __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepodpresetv1alpha1-manifest"></a>
...
## class KubePodSecurityPolicyListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepodsecuritypolicylistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubePodSecurityPolicyListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubepodsecuritypolicylistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubePodSecurityPolicyV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubepodsecuritypolicyv1beta1props)></code>)  items is a list of schema objects. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepodsecuritypolicylistv1beta1-manifest"></a>
...
## class KubePodSecurityPolicyV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepodsecuritypolicyv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubePodSecurityPolicyV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubepodsecuritypolicyv1beta1props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **spec** (<code>[k8s.PodSecurityPolicySpec](#opencdk8s-cdk8s-argo-rollout-k8s-podsecuritypolicyspec)</code>)  spec defines the policy enforced. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepodsecuritypolicyv1beta1-manifest"></a>
...
## class KubePodTemplate 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepodtemplate"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubePodTemplateProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubepodtemplateprops)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **template** (<code>[k8s.PodTemplateSpec](#opencdk8s-cdk8s-argo-rollout-k8s-podtemplatespec)</code>)  Template defines the pods that will be created from this pod template. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepodtemplate-manifest"></a>
...
## class KubePodTemplateList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepodtemplatelist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubePodTemplateListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubepodtemplatelistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubePodTemplateProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubepodtemplateprops)></code>)  List of pod templates. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepodtemplatelist-manifest"></a>
...
## class KubePriorityClass 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclass"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubePriorityClassProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclassprops)</code>)  initialization props.
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclass-manifest"></a>
...
## class KubePriorityClassList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclasslist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubePriorityClassListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclasslistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubePriorityClassProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclassprops)></code>)  items is the list of PriorityClasses. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclasslist-manifest"></a>
...
## class KubePriorityClassListV1Alpha1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclasslistv1alpha1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubePriorityClassListV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclasslistv1alpha1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubePriorityClassV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclassv1alpha1props)></code>)  items is the list of PriorityClasses. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclasslistv1alpha1-manifest"></a>
...
## class KubePriorityClassListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclasslistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubePriorityClassListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclasslistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubePriorityClassV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclassv1beta1props)></code>)  items is the list of PriorityClasses. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclasslistv1beta1-manifest"></a>
...
## class KubePriorityClassV1Alpha1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclassv1alpha1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubePriorityClassV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclassv1alpha1props)</code>)  initialization props.
  * **value** (<code>number</code>)  The value of this priority class. 
  * **description** (<code>string</code>)  description is an arbitrary string that usually provides guidelines on when this priority class should be used. __*Optional*__
  * **globalDefault** (<code>boolean</code>)  globalDefault specifies whether this PriorityClass should be considered as the default priority for pods that do not have any priority class. __*Optional*__
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclassv1alpha1-manifest"></a>
...
## class KubePriorityClassV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclassv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubePriorityClassV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclassv1beta1props)</code>)  initialization props.
  * **value** (<code>number</code>)  The value of this priority class. 
  * **description** (<code>string</code>)  description is an arbitrary string that usually provides guidelines on when this priority class should be used. __*Optional*__
  * **globalDefault** (<code>boolean</code>)  globalDefault specifies whether this PriorityClass should be considered as the default priority for pods that do not have any priority class. __*Optional*__
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclassv1beta1-manifest"></a>
...
## class KubeReplicaSet 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicaset"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeReplicaSetProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetprops)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  If the Labels of a ReplicaSet are empty, they are defaulted to be the same as the Pod(s) that the ReplicaSet manages. __*Optional*__
  * **spec** (<code>[k8s.ReplicaSetSpec](#opencdk8s-cdk8s-argo-rollout-k8s-replicasetspec)</code>)  Spec defines the specification of the desired behavior of the ReplicaSet. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicaset-manifest"></a>
...
## class KubeReplicaSetList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetlist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeReplicaSetListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetlistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeReplicaSetProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetprops)></code>)  List of ReplicaSets. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetlist-manifest"></a>
...
## class KubeReplicaSetListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetlistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeReplicaSetListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetlistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeReplicaSetV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetv1beta1props)></code>)  List of ReplicaSets. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetlistv1beta1-manifest"></a>
...
## class KubeReplicaSetListV1Beta2 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetlistv1beta2"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeReplicaSetListV1Beta2Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetlistv1beta2props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeReplicaSetV1Beta2Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetv1beta2props)></code>)  List of ReplicaSets. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetlistv1beta2-manifest"></a>
...
## class KubeReplicaSetV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeReplicaSetV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetv1beta1props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  If the Labels of a ReplicaSet are empty, they are defaulted to be the same as the Pod(s) that the ReplicaSet manages. __*Optional*__
  * **spec** (<code>[k8s.ReplicaSetSpec](#opencdk8s-cdk8s-argo-rollout-k8s-replicasetspec)</code>)  Spec defines the specification of the desired behavior of the ReplicaSet. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetv1beta1-manifest"></a>
...
## class KubeReplicaSetV1Beta2 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetv1beta2"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeReplicaSetV1Beta2Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetv1beta2props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  If the Labels of a ReplicaSet are empty, they are defaulted to be the same as the Pod(s) that the ReplicaSet manages. __*Optional*__
  * **spec** (<code>[k8s.ReplicaSetSpec](#opencdk8s-cdk8s-argo-rollout-k8s-replicasetspec)</code>)  Spec defines the specification of the desired behavior of the ReplicaSet. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetv1beta2-manifest"></a>
...
## class KubeReplicationController 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicationcontroller"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeReplicationControllerProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubereplicationcontrollerprops)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  If the Labels of a ReplicationController are empty, they are defaulted to be the same as the Pod(s) that the replication controller manages. __*Optional*__
  * **spec** (<code>[k8s.ReplicationControllerSpec](#opencdk8s-cdk8s-argo-rollout-k8s-replicationcontrollerspec)</code>)  Spec defines the specification of the desired behavior of the replication controller. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicationcontroller-manifest"></a>
...
## class KubeReplicationControllerList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicationcontrollerlist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeReplicationControllerListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubereplicationcontrollerlistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeReplicationControllerProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubereplicationcontrollerprops)></code>)  List of replication controllers. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicationcontrollerlist-manifest"></a>
...
## class KubeResourceQuota 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberesourcequota"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeResourceQuotaProps](#opencdk8s-cdk8s-argo-rollout-k8s-kuberesourcequotaprops)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **spec** (<code>[k8s.ResourceQuotaSpec](#opencdk8s-cdk8s-argo-rollout-k8s-resourcequotaspec)</code>)  Spec defines the desired quota. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberesourcequota-manifest"></a>
...
## class KubeResourceQuotaList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberesourcequotalist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeResourceQuotaListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kuberesourcequotalistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeResourceQuotaProps](#opencdk8s-cdk8s-argo-rollout-k8s-kuberesourcequotaprops)></code>)  Items is a list of ResourceQuota objects. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberesourcequotalist-manifest"></a>
...
## class KubeRole 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberole"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeRoleProps](#opencdk8s-cdk8s-argo-rollout-k8s-kuberoleprops)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **rules** (<code>Array<[k8s.PolicyRule](#opencdk8s-cdk8s-argo-rollout-k8s-policyrule)></code>)  Rules holds all the PolicyRules for this Role. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberole-manifest"></a>
...
## class KubeRoleBinding 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolebinding"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeRoleBindingProps](#opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindingprops)</code>)  initialization props.
  * **roleRef** (<code>[k8s.RoleRef](#opencdk8s-cdk8s-argo-rollout-k8s-roleref)</code>)  RoleRef can reference a Role in the current namespace or a ClusterRole in the global namespace. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **subjects** (<code>Array<[k8s.Subject](#opencdk8s-cdk8s-argo-rollout-k8s-subject)></code>)  Subjects holds references to the objects the role applies to. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolebinding-manifest"></a>
...
## class KubeRoleBindingList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindinglist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeRoleBindingListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindinglistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeRoleBindingProps](#opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindingprops)></code>)  Items is a list of RoleBindings. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard object's metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindinglist-manifest"></a>
...
## class KubeRoleBindingListV1Alpha1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindinglistv1alpha1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeRoleBindingListV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindinglistv1alpha1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeRoleBindingV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindingv1alpha1props)></code>)  Items is a list of RoleBindings. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard object's metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindinglistv1alpha1-manifest"></a>
...
## class KubeRoleBindingListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindinglistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeRoleBindingListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindinglistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeRoleBindingV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindingv1beta1props)></code>)  Items is a list of RoleBindings. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard object's metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindinglistv1beta1-manifest"></a>
...
## class KubeRoleBindingV1Alpha1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindingv1alpha1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeRoleBindingV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindingv1alpha1props)</code>)  initialization props.
  * **roleRef** (<code>[k8s.RoleRef](#opencdk8s-cdk8s-argo-rollout-k8s-roleref)</code>)  RoleRef can reference a Role in the current namespace or a ClusterRole in the global namespace. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **subjects** (<code>Array<[k8s.Subject](#opencdk8s-cdk8s-argo-rollout-k8s-subject)></code>)  Subjects holds references to the objects the role applies to. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindingv1alpha1-manifest"></a>
...
## class KubeRoleBindingV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindingv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeRoleBindingV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindingv1beta1props)</code>)  initialization props.
  * **roleRef** (<code>[k8s.RoleRef](#opencdk8s-cdk8s-argo-rollout-k8s-roleref)</code>)  RoleRef can reference a Role in the current namespace or a ClusterRole in the global namespace. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **subjects** (<code>Array<[k8s.Subject](#opencdk8s-cdk8s-argo-rollout-k8s-subject)></code>)  Subjects holds references to the objects the role applies to. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindingv1beta1-manifest"></a>
...
## class KubeRoleList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolelist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeRoleListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kuberolelistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeRoleProps](#opencdk8s-cdk8s-argo-rollout-k8s-kuberoleprops)></code>)  Items is a list of Roles. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard object's metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolelist-manifest"></a>
...
## class KubeRoleListV1Alpha1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolelistv1alpha1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeRoleListV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kuberolelistv1alpha1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeRoleV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kuberolev1alpha1props)></code>)  Items is a list of Roles. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard object's metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolelistv1alpha1-manifest"></a>
...
## class KubeRoleListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolelistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeRoleListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kuberolelistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeRoleV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kuberolev1beta1props)></code>)  Items is a list of Roles. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard object's metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolelistv1beta1-manifest"></a>
...
## class KubeRoleV1Alpha1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolev1alpha1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeRoleV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kuberolev1alpha1props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **rules** (<code>Array<[k8s.PolicyRule](#opencdk8s-cdk8s-argo-rollout-k8s-policyrule)></code>)  Rules holds all the PolicyRules for this Role. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolev1alpha1-manifest"></a>
...
## class KubeRoleV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolev1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeRoleV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kuberolev1beta1props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **rules** (<code>Array<[k8s.PolicyRule](#opencdk8s-cdk8s-argo-rollout-k8s-policyrule)></code>)  Rules holds all the PolicyRules for this Role. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolev1beta1-manifest"></a>
...
## class KubeRuntimeClassListV1Alpha1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberuntimeclasslistv1alpha1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeRuntimeClassListV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kuberuntimeclasslistv1alpha1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeRuntimeClassV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kuberuntimeclassv1alpha1props)></code>)  Items is a list of schema objects. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberuntimeclasslistv1alpha1-manifest"></a>
...
## class KubeRuntimeClassListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberuntimeclasslistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeRuntimeClassListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kuberuntimeclasslistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeRuntimeClassV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kuberuntimeclassv1beta1props)></code>)  Items is a list of schema objects. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberuntimeclasslistv1beta1-manifest"></a>
...
## class KubeRuntimeClassV1Alpha1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberuntimeclassv1alpha1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeRuntimeClassV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kuberuntimeclassv1alpha1props)</code>)  initialization props.
  * **spec** (<code>[k8s.RuntimeClassSpec](#opencdk8s-cdk8s-argo-rollout-k8s-runtimeclassspec)</code>)  Specification of the RuntimeClass More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberuntimeclassv1alpha1-manifest"></a>
...
## class KubeRuntimeClassV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberuntimeclassv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeRuntimeClassV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kuberuntimeclassv1beta1props)</code>)  initialization props.
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberuntimeclassv1beta1-manifest"></a>
...
## class KubeScale 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubescale"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeScaleProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubescaleprops)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object metadata; __*Optional*__
  * **spec** (<code>[k8s.ScaleSpec](#opencdk8s-cdk8s-argo-rollout-k8s-scalespec)</code>)  defines the behavior of the scale. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubescale-manifest"></a>
...
## class KubeScaleV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubescalev1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeScaleV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubescalev1beta1props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object metadata; __*Optional*__
  * **spec** (<code>[k8s.ScaleSpec](#opencdk8s-cdk8s-argo-rollout-k8s-scalespec)</code>)  defines the behavior of the scale. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubescalev1beta1-manifest"></a>
...
## class KubeScaleV1Beta2 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubescalev1beta2"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeScaleV1Beta2Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubescalev1beta2props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object metadata; __*Optional*__
  * **spec** (<code>[k8s.ScaleSpec](#opencdk8s-cdk8s-argo-rollout-k8s-scalespec)</code>)  defines the behavior of the scale. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubescalev1beta2-manifest"></a>
...
## class KubeSecret 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubesecret"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeSecretProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubesecretprops)</code>)  initialization props.
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubesecret-manifest"></a>
...
## class KubeSecretList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubesecretlist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeSecretListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubesecretlistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeSecretProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubesecretprops)></code>)  Items is a list of secret objects. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubesecretlist-manifest"></a>
...
## class KubeSelfSubjectAccessReview 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeselfsubjectaccessreview"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeSelfSubjectAccessReviewProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeselfsubjectaccessreviewprops)</code>)  initialization props.
  * **spec** (<code>[k8s.SelfSubjectAccessReviewSpec](#opencdk8s-cdk8s-argo-rollout-k8s-selfsubjectaccessreviewspec)</code>)  Spec holds information about the request being evaluated. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  *No description* __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeselfsubjectaccessreview-manifest"></a>
...
## class KubeSelfSubjectAccessReviewV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeselfsubjectaccessreviewv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeSelfSubjectAccessReviewV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeselfsubjectaccessreviewv1beta1props)</code>)  initialization props.
  * **spec** (<code>[k8s.SelfSubjectAccessReviewSpec](#opencdk8s-cdk8s-argo-rollout-k8s-selfsubjectaccessreviewspec)</code>)  Spec holds information about the request being evaluated. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  *No description* __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeselfsubjectaccessreviewv1beta1-manifest"></a>
...
## class KubeSelfSubjectRulesReview 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeselfsubjectrulesreview"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeSelfSubjectRulesReviewProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeselfsubjectrulesreviewprops)</code>)  initialization props.
  * **spec** (<code>[k8s.SelfSubjectRulesReviewSpec](#opencdk8s-cdk8s-argo-rollout-k8s-selfsubjectrulesreviewspec)</code>)  Spec holds information about the request being evaluated. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  *No description* __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeselfsubjectrulesreview-manifest"></a>
...
## class KubeSelfSubjectRulesReviewV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeselfsubjectrulesreviewv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeSelfSubjectRulesReviewV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeselfsubjectrulesreviewv1beta1props)</code>)  initialization props.
  * **spec** (<code>[k8s.SelfSubjectRulesReviewSpec](#opencdk8s-cdk8s-argo-rollout-k8s-selfsubjectrulesreviewspec)</code>)  Spec holds information about the request being evaluated. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  *No description* __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeselfsubjectrulesreviewv1beta1-manifest"></a>
...
## class KubeService 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeservice"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeServiceProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeserviceprops)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **spec** (<code>[k8s.ServiceSpec](#opencdk8s-cdk8s-argo-rollout-k8s-servicespec)</code>)  Spec defines the behavior of a service. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeservice-manifest"></a>
...
## class KubeServiceAccount 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeserviceaccount"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeServiceAccountProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeserviceaccountprops)</code>)  initialization props.
  ...
  * **imagePullSecrets** (<code>Array<[k8s.LocalObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-localobjectreference)></code>)  ImagePullSecrets is a list of references to secrets in the same namespace to use for pulling any images in pods that reference this ServiceAccount. __*Optional*__
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
  * **secrets** (<code>Array<[k8s.ObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-objectreference)></code>)  Secrets is the list of secrets allowed to be used by pods running using this ServiceAccount. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeserviceaccount-manifest"></a>
...
## class KubeServiceAccountList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeserviceaccountlist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeServiceAccountListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeserviceaccountlistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeServiceAccountProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeserviceaccountprops)></code>)  List of ServiceAccounts. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeserviceaccountlist-manifest"></a>
...
## class KubeServiceList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeservicelist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeServiceListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeservicelistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeServiceProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeserviceprops)></code>)  List of services. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeservicelist-manifest"></a>
...
## class KubeStatefulSet 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulset"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeStatefulSetProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetprops)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  *No description* __*Optional*__
  * **spec** (<code>[k8s.StatefulSetSpec](#opencdk8s-cdk8s-argo-rollout-k8s-statefulsetspec)</code>)  Spec defines the desired identities of pods in this set. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulset-manifest"></a>
...
## class KubeStatefulSetList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetlist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeStatefulSetListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetlistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeStatefulSetProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetprops)></code>)  *No description* 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  *No description* __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetlist-manifest"></a>
...
## class KubeStatefulSetListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetlistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeStatefulSetListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetlistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeStatefulSetV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetv1beta1props)></code>)  *No description* 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  *No description* __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetlistv1beta1-manifest"></a>
...
## class KubeStatefulSetListV1Beta2 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetlistv1beta2"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeStatefulSetListV1Beta2Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetlistv1beta2props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeStatefulSetV1Beta2Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetv1beta2props)></code>)  *No description* 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  *No description* __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetlistv1beta2-manifest"></a>
...
## class KubeStatefulSetV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeStatefulSetV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetv1beta1props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  *No description* __*Optional*__
  * **spec** (<code>[k8s.StatefulSetSpec](#opencdk8s-cdk8s-argo-rollout-k8s-statefulsetspec)</code>)  Spec defines the desired identities of pods in this set. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetv1beta1-manifest"></a>
...
## class KubeStatefulSetV1Beta2 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetv1beta2"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeStatefulSetV1Beta2Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetv1beta2props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  *No description* __*Optional*__
  * **spec** (<code>[k8s.StatefulSetSpec](#opencdk8s-cdk8s-argo-rollout-k8s-statefulsetspec)</code>)  Spec defines the desired identities of pods in this set. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetv1beta2-manifest"></a>
...
## class KubeStatus 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestatus"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeStatusProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubestatusprops)</code>)  initialization props.
  * **code** (<code>number</code>)  Suggested HTTP return code for this status, 0 if not set. __*Optional*__
  * **details** (<code>[k8s.StatusDetails](#opencdk8s-cdk8s-argo-rollout-k8s-statusdetails)</code>)  Extended data associated with the reason. __*Optional*__
  * **message** (<code>string</code>)  A human-readable description of the status of this operation. __*Optional*__
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestatus-manifest"></a>
...
## class KubeStorageClass 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestorageclass"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeStorageClassProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubestorageclassprops)</code>)  initialization props.
  * **provisioner** (<code>string</code>)  Provisioner indicates the type of the provisioner. 
  * **allowedTopologies** (<code>Array<[k8s.TopologySelectorTerm](#opencdk8s-cdk8s-argo-rollout-k8s-topologyselectorterm)></code>)  Restrict the node topologies where volumes can be dynamically provisioned. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestorageclass-manifest"></a>
...
## class KubeStorageClassList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestorageclasslist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeStorageClassListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubestorageclasslistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeStorageClassProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubestorageclassprops)></code>)  Items is the list of StorageClasses. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestorageclasslist-manifest"></a>
...
## class KubeStorageClassListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestorageclasslistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeStorageClassListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubestorageclasslistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeStorageClassV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubestorageclassv1beta1props)></code>)  Items is the list of StorageClasses. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestorageclasslistv1beta1-manifest"></a>
...
## class KubeStorageClassV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestorageclassv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeStorageClassV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubestorageclassv1beta1props)</code>)  initialization props.
  * **provisioner** (<code>string</code>)  Provisioner indicates the type of the provisioner. 
  * **allowedTopologies** (<code>Array<[k8s.TopologySelectorTerm](#opencdk8s-cdk8s-argo-rollout-k8s-topologyselectorterm)></code>)  Restrict the node topologies where volumes can be dynamically provisioned. __*Optional*__
  * **allowVolumeExpansion** (<code>boolean</code>)  AllowVolumeExpansion shows whether the storage class allow volume expand. __*Optional*__
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object's metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestorageclassv1beta1-manifest"></a>
...
## class KubeSubjectAccessReview 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubesubjectaccessreview"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeSubjectAccessReviewProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubesubjectaccessreviewprops)</code>)  initialization props.
  * **spec** (<code>[k8s.SubjectAccessReviewSpec](#opencdk8s-cdk8s-argo-rollout-k8s-subjectaccessreviewspec)</code>)  Spec holds information about the request being evaluated. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  *No description* __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubesubjectaccessreview-manifest"></a>
...
## class KubeSubjectAccessReviewV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubesubjectaccessreviewv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeSubjectAccessReviewV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubesubjectaccessreviewv1beta1props)</code>)  initialization props.
  * **spec** (<code>[k8s.SubjectAccessReviewSpec](#opencdk8s-cdk8s-argo-rollout-k8s-subjectaccessreviewspec)</code>)  Spec holds information about the request being evaluated. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  *No description* __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubesubjectaccessreviewv1beta1-manifest"></a>
...
## class KubeTokenReview 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubetokenreview"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeTokenReviewProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubetokenreviewprops)</code>)  initialization props.
  * **spec** (<code>[k8s.TokenReviewSpec](#opencdk8s-cdk8s-argo-rollout-k8s-tokenreviewspec)</code>)  Spec holds information about the request being evaluated. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  *No description* __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubetokenreview-manifest"></a>
...
## class KubeTokenReviewV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubetokenreviewv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeTokenReviewV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubetokenreviewv1beta1props)</code>)  initialization props.
  * **spec** (<code>[k8s.TokenReviewSpec](#opencdk8s-cdk8s-argo-rollout-k8s-tokenreviewspec)</code>)  Spec holds information about the request being evaluated. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  *No description* __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubetokenreviewv1beta1-manifest"></a>
...
## class KubeValidatingWebhookConfigurationListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevalidatingwebhookconfigurationlistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeValidatingWebhookConfigurationListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubevalidatingwebhookconfigurationlistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeValidatingWebhookConfigurationV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubevalidatingwebhookconfigurationv1beta1props)></code>)  List of ValidatingWebhookConfiguration. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevalidatingwebhookconfigurationlistv1beta1-manifest"></a>
...
## class KubeValidatingWebhookConfigurationV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevalidatingwebhookconfigurationv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeValidatingWebhookConfigurationV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubevalidatingwebhookconfigurationv1beta1props)</code>)  initialization props.
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object metadata; __*Optional*__
  * **webhooks** (<code>Array<[k8s.ValidatingWebhook](#opencdk8s-cdk8s-argo-rollout-k8s-validatingwebhook)></code>)  Webhooks is a list of webhooks and the affected resources and operations. __*Optional*__
...
#### *static* manifest(props?)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevalidatingwebhookconfigurationv1beta1-manifest"></a>
...
## class KubeVolumeAttachment 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachment"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeVolumeAttachmentProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentprops)</code>)  initialization props.
  * **spec** (<code>[k8s.VolumeAttachmentSpec](#opencdk8s-cdk8s-argo-rollout-k8s-volumeattachmentspec)</code>)  Specification of the desired attach/detach volume behavior. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachment-manifest"></a>
...
## class KubeVolumeAttachmentList 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentlist"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeVolumeAttachmentListProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentlistprops)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeVolumeAttachmentProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentprops)></code>)  Items is the list of VolumeAttachments. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentlist-manifest"></a>
...
## class KubeVolumeAttachmentListV1Alpha1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentlistv1alpha1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeVolumeAttachmentListV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentlistv1alpha1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeVolumeAttachmentV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentv1alpha1props)></code>)  Items is the list of VolumeAttachments. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentlistv1alpha1-manifest"></a>
...
## class KubeVolumeAttachmentListV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentlistv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeVolumeAttachmentListV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentlistv1beta1props)</code>)  initialization props.
  * **items** (<code>Array<[k8s.KubeVolumeAttachmentV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentv1beta1props)></code>)  Items is the list of VolumeAttachments. 
  * **metadata** (<code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code>)  Standard list metadata More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentlistv1beta1-manifest"></a>
...
## class KubeVolumeAttachmentV1Alpha1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentv1alpha1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeVolumeAttachmentV1Alpha1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentv1alpha1props)</code>)  initialization props.
  * **spec** (<code>[k8s.VolumeAttachmentSpec](#opencdk8s-cdk8s-argo-rollout-k8s-volumeattachmentspec)</code>)  Specification of the desired attach/detach volume behavior. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentv1alpha1-manifest"></a>
...
## class KubeVolumeAttachmentV1Beta1 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentv1beta1"></a>
...
* **scope** (<code>[Construct](#constructs-construct)</code>)  the scope in which to define this object.
* **id** (<code>string</code>)  a scope-local name for the object.
* **props** (<code>[k8s.KubeVolumeAttachmentV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentv1beta1props)</code>)  initialization props.
  * **spec** (<code>[k8s.VolumeAttachmentSpec](#opencdk8s-cdk8s-argo-rollout-k8s-volumeattachmentspec)</code>)  Specification of the desired attach/detach volume behavior. 
  * **metadata** (<code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code>)  Standard object metadata. __*Optional*__
...
#### *static* manifest(props)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentv1beta1-manifest"></a>
...
## class Quantity 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-quantity"></a>
...
#### *static* fromNumber(value)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-quantity-fromnumber"></a>
...
__Returns__:
* <code>[k8s.Quantity](#opencdk8s-cdk8s-argo-rollout-k8s-quantity)</code>

#### *static* fromString(value)🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-quantity-fromstring"></a>
...
## struct AnalysisArgs 🔹 <a id="opencdk8s-cdk8s-argo-rollout-analysisargs"></a>
...
**valueFrom**?🔹 | <code>[ValueFrom](#opencdk8s-cdk8s-argo-rollout-valuefrom)</code> | __*Optional*__



## struct AnalysisSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-analysisspec"></a>
...
Name | Type | Description 
-----|------|-------------
**args**🔹 | <code>Array<[AnalysisArgs](#opencdk8s-cdk8s-argo-rollout-analysisargs)></code> | <span></span>
**templates**🔹 | <code>Array<[AnalysisTemplate](#opencdk8s-cdk8s-argo-rollout-analysistemplate)></code> | <span></span>



## struct AnalysisTemplate 🔹 <a id="opencdk8s-cdk8s-argo-rollout-analysistemplate"></a>
...
## struct ArgoRolloutProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-argorolloutprops"></a>
...
Name | Type | Description 
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__
**spec**?🔹 | <code>[ArgoSpecs](#opencdk8s-cdk8s-argo-rollout-argospecs)</code> | Spec defines the behavior of the ingress.<br/>__*Optional*__



## struct ArgoSpecs 🔹 <a id="opencdk8s-cdk8s-argo-rollout-argospecs"></a>
...
Name | Type | Description 
-----|------|-------------
**selector**🔹 | <code>[k8s.LabelSelector](#opencdk8s-cdk8s-argo-rollout-k8s-labelselector)</code> | <span></span>
**strategy**🔹 | <code>[StrategySpecs](#opencdk8s-cdk8s-argo-rollout-strategyspecs)</code> | <span></span>
**template**🔹 | <code>[k8s.PodTemplateSpec](#opencdk8s-cdk8s-argo-rollout-k8s-podtemplatespec)</code> | <span></span>
**minReadySeconds**?🔹 | <code>number</code> | __*Optional*__
**paused**?🔹 | <code>boolean</code> | __*Optional*__
**progressDeadlineSeconds**?🔹 | <code>number</code> | __*Optional*__
**replicas**?🔹 | <code>number</code> | __*Optional*__
**revisionHistoryLimit**?🔹 | <code>number</code> | __*Optional*__



## struct BlueGreenStrategySpecs 🔹 <a id="opencdk8s-cdk8s-argo-rollout-bluegreenstrategyspecs"></a>
...
**prePromotionAnalysis**?🔹 | <code>[AnalysisSpec](#opencdk8s-cdk8s-argo-rollout-analysisspec)</code> | __*Optional*__
**previewReplicaCount**?🔹 | <code>number</code> | __*Optional*__
**previewService**?🔹 | <code>string</code> | __*Optional*__
**scaleDownDelayRevisionLimit**?🔹 | <code>number</code> | __*Optional*__
**scaleDownDelaySeconds**?🔹 | <code>number</code> | __*Optional*__



## struct StrategySpecs 🔹 <a id="opencdk8s-cdk8s-argo-rollout-strategyspecs"></a>
...
Name | Type | Description 
-----|------|-------------
**blueGreen**🔹 | <code>[BlueGreenStrategySpecs](#opencdk8s-cdk8s-argo-rollout-bluegreenstrategyspecs)</code> | <span></span>



## struct ValueFrom 🔹 <a id="opencdk8s-cdk8s-argo-rollout-valuefrom"></a>
...
Name | Type | Description 
-----|------|-------------
**fieldRef**?🔹 | <code>[k8s.ObjectFieldSelector](#opencdk8s-cdk8s-argo-rollout-k8s-objectfieldselector)</code> | __*Optional*__
**podTemplateHashValue**?🔹 | <code>string</code> | __*Optional*__



## struct Affinity 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-affinity"></a>
...
Name | Type | Description 
-----|------|-------------
**nodeAffinity**?🔹 | <code>[k8s.NodeAffinity](#opencdk8s-cdk8s-argo-rollout-k8s-nodeaffinity)</code> | Describes node affinity scheduling rules for the pod.<br/>__*Optional*__
**podAffinity**?🔹 | <code>[k8s.PodAffinity](#opencdk8s-cdk8s-argo-rollout-k8s-podaffinity)</code> | Describes pod affinity scheduling rules (e.g. co-locate this pod in the same node, zone, etc. as some other pod(s)).<br/>__*Optional*__
**podAntiAffinity**?🔹 | <code>[k8s.PodAntiAffinity](#opencdk8s-cdk8s-argo-rollout-k8s-podantiaffinity)</code> | Describes pod anti-affinity scheduling rules (e.g. avoid putting this pod in the same node, zone, etc. as some other pod(s)).<br/>__*Optional*__



## struct AggregationRule 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-aggregationrule"></a>
...
Name | Type | Description 
-----|------|-------------
**clusterRoleSelectors**?🔹 | <code>Array<[k8s.LabelSelector](#opencdk8s-cdk8s-argo-rollout-k8s-labelselector)></code> | ClusterRoleSelectors holds a list of selectors which will be used to find ClusterRoles and create the rules.<br/>__*Optional*__



## struct AllowedCsiDriver 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-allowedcsidriver"></a>
...
## struct AllowedFlexVolume 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-allowedflexvolume"></a>
...
## struct AllowedHostPath 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-allowedhostpath"></a>
...
## struct ApiServiceSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-apiservicespec"></a>
...
**service**🔹 | <code>[k8s.ServiceReference](#opencdk8s-cdk8s-argo-rollout-k8s-servicereference)</code> | Service is a reference to the service for this API server.
...
## struct AuditSinkSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-auditsinkspec"></a>
...
Name | Type | Description 
-----|------|-------------
**policy**🔹 | <code>[k8s.Policy](#opencdk8s-cdk8s-argo-rollout-k8s-policy)</code> | Policy defines the policy for selecting which events should be sent to the webhook required.
**webhook**🔹 | <code>[k8s.Webhook](#opencdk8s-cdk8s-argo-rollout-k8s-webhook)</code> | Webhook to send events required.



## struct AwsElasticBlockStoreVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-awselasticblockstorevolumesource"></a>
...
## struct AzureDiskVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-azurediskvolumesource"></a>
...
## struct AzureFilePersistentVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-azurefilepersistentvolumesource"></a>
...
## struct AzureFileVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-azurefilevolumesource"></a>
...
## struct Capabilities 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-capabilities"></a>
...
## struct CephFsPersistentVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-cephfspersistentvolumesource"></a>
...
**secretRef**?🔹 | <code>[k8s.SecretReference](#opencdk8s-cdk8s-argo-rollout-k8s-secretreference)</code> | Optional: SecretRef is reference to the authentication secret for User, default is empty.<br/>__*Optional*__
...
## struct CephFsVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-cephfsvolumesource"></a>
...
**readOnly**?🔹 | <code>boolean</code> | Optional: Defaults to false (read/write).<br/>__*Default*__: false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts. More info: https://releases.k8s.io/HEAD/examples/volumes/cephfs/README.md#how-to-use-it
**secretFile**?🔹 | <code>string</code> | Optional: SecretFile is the path to key ring for User, default is /etc/ceph/user.secret More info: https://releases.k8s.io/HEAD/examples/volumes/cephfs/README.md#how-to-use-it.<br/>__*Optional*__
**secretRef**?🔹 | <code>[k8s.LocalObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-localobjectreference)</code> | Optional: SecretRef is reference to the authentication secret for User, default is empty.<br/>__*Optional*__
**user**?🔹 | <code>string</code> | Optional: User is the rados user name, default is admin More info: https://releases.k8s.io/HEAD/examples/volumes/cephfs/README.md#how-to-use-it.<br/>__*Optional*__



## struct CertificateSigningRequestSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-certificatesigningrequestspec"></a>
...
## struct CinderPersistentVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-cinderpersistentvolumesource"></a>
...
**secretRef**?🔹 | <code>[k8s.SecretReference](#opencdk8s-cdk8s-argo-rollout-k8s-secretreference)</code> | Optional: points to a secret object containing parameters used to connect to OpenStack.<br/>__*Optional*__



## struct CinderVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-cindervolumesource"></a>
...
**fsType**?🔹 | <code>string</code> | Filesystem type to mount.<br/>__*Optional*__
**readOnly**?🔹 | <code>boolean</code> | Optional: Defaults to false (read/write).<br/>__*Default*__: false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts. More info: https://releases.k8s.io/HEAD/examples/mysql-cinder-pd/README.md
**secretRef**?🔹 | <code>[k8s.LocalObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-localobjectreference)</code> | Optional: points to a secret object containing parameters used to connect to OpenStack.<br/>__*Optional*__



## struct ClientIpConfig 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-clientipconfig"></a>
...
## struct ComponentCondition 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-componentcondition"></a>
...
## struct ConfigMapEnvSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-configmapenvsource"></a>
...
## struct ConfigMapKeySelector 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-configmapkeyselector"></a>
...
## struct ConfigMapNodeConfigSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-configmapnodeconfigsource"></a>
...
## struct ConfigMapProjection 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-configmapprojection"></a>
...
Name | Type | Description 
-----|------|-------------
**items**?🔹 | <code>Array<[k8s.KeyToPath](#opencdk8s-cdk8s-argo-rollout-k8s-keytopath)></code> | If unspecified, each key-value pair in the Data field of the referenced ConfigMap will be projected into the volume as a file whose name is the key and content is the value.<br/>__*Optional*__
**name**?🔹 | <code>string</code> | Name of the referent.<br/>__*Optional*__
**optional**?🔹 | <code>boolean</code> | Specify whether the ConfigMap or its keys must be defined.<br/>__*Optional*__



## struct ConfigMapVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-configmapvolumesource"></a>
...
## struct Container 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-container"></a>
...
**env**?🔹 | <code>Array<[k8s.EnvVar](#opencdk8s-cdk8s-argo-rollout-k8s-envvar)></code> | List of environment variables to set in the container.<br/>__*Optional*__
**envFrom**?🔹 | <code>Array<[k8s.EnvFromSource](#opencdk8s-cdk8s-argo-rollout-k8s-envfromsource)></code> | List of sources to populate environment variables in the container.<br/>__*Optional*__
...
**lifecycle**?🔹 | <code>[k8s.Lifecycle](#opencdk8s-cdk8s-argo-rollout-k8s-lifecycle)</code> | Actions that the management system should take in response to container lifecycle events.<br/>__*Optional*__
**livenessProbe**?🔹 | <code>[k8s.Probe](#opencdk8s-cdk8s-argo-rollout-k8s-probe)</code> | Periodic probe of container liveness.<br/>__*Optional*__
**ports**?🔹 | <code>Array<[k8s.ContainerPort](#opencdk8s-cdk8s-argo-rollout-k8s-containerport)></code> | List of ports to expose from the container.<br/>__*Optional*__
**readinessProbe**?🔹 | <code>[k8s.Probe](#opencdk8s-cdk8s-argo-rollout-k8s-probe)</code> | Periodic probe of container service readiness.<br/>__*Optional*__
**resources**?🔹 | <code>[k8s.ResourceRequirements](#opencdk8s-cdk8s-argo-rollout-k8s-resourcerequirements)</code> | Compute Resources required by this container.<br/>__*Optional*__
**securityContext**?🔹 | <code>[k8s.SecurityContext](#opencdk8s-cdk8s-argo-rollout-k8s-securitycontext)</code> | Security options the pod should run with.<br/>__*Optional*__
...
**volumeDevices**?🔹 | <code>Array<[k8s.VolumeDevice](#opencdk8s-cdk8s-argo-rollout-k8s-volumedevice)></code> | volumeDevices is the list of block devices to be used by the container.<br/>__*Optional*__
**volumeMounts**?🔹 | <code>Array<[k8s.VolumeMount](#opencdk8s-cdk8s-argo-rollout-k8s-volumemount)></code> | Pod volumes to mount into the container's filesystem.<br/>__*Optional*__
**workingDir**?🔹 | <code>string</code> | Container's working directory.<br/>__*Optional*__



## struct ContainerPort 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-containerport"></a>
...
## struct CronJobSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-cronjobspec"></a>
...
Name | Type | Description 
-----|------|-------------
**jobTemplate**🔹 | <code>[k8s.JobTemplateSpec](#opencdk8s-cdk8s-argo-rollout-k8s-jobtemplatespec)</code> | Specifies the job that will be created when executing a CronJob.
...
## struct CrossVersionObjectReference 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-crossversionobjectreference"></a>
...
## struct CsiDriverSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-csidriverspec"></a>
...
## struct CsiNodeDriver 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-csinodedriver"></a>
...
## struct CsiNodeSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-csinodespec"></a>
...
Name | Type | Description 
-----|------|-------------
**drivers**🔹 | <code>Array<[k8s.CsiNodeDriver](#opencdk8s-cdk8s-argo-rollout-k8s-csinodedriver)></code> | drivers is a list of information of all CSI Drivers existing on a node.



## struct CsiPersistentVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-csipersistentvolumesource"></a>
...
**controllerExpandSecretRef**?🔹 | <code>[k8s.SecretReference](#opencdk8s-cdk8s-argo-rollout-k8s-secretreference)</code> | ControllerExpandSecretRef is a reference to the secret object containing sensitive information to pass to the CSI driver to complete the CSI ControllerExpandVolume call.<br/>__*Optional*__
**controllerPublishSecretRef**?🔹 | <code>[k8s.SecretReference](#opencdk8s-cdk8s-argo-rollout-k8s-secretreference)</code> | ControllerPublishSecretRef is a reference to the secret object containing sensitive information to pass to the CSI driver to complete the CSI ControllerPublishVolume and ControllerUnpublishVolume calls.<br/>__*Optional*__
**fsType**?🔹 | <code>string</code> | Filesystem type to mount.<br/>__*Optional*__
**nodePublishSecretRef**?🔹 | <code>[k8s.SecretReference](#opencdk8s-cdk8s-argo-rollout-k8s-secretreference)</code> | NodePublishSecretRef is a reference to the secret object containing sensitive information to pass to the CSI driver to complete the CSI NodePublishVolume and NodeUnpublishVolume calls.<br/>__*Optional*__
**nodeStageSecretRef**?🔹 | <code>[k8s.SecretReference](#opencdk8s-cdk8s-argo-rollout-k8s-secretreference)</code> | NodeStageSecretRef is a reference to the secret object containing sensitive information to pass to the CSI driver to complete the CSI NodeStageVolume and NodeStageVolume and NodeUnstageVolume calls.<br/>__*Optional*__
...
## struct CsiVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-csivolumesource"></a>
...
**fsType**?🔹 | <code>string</code> | Filesystem type to mount.<br/>__*Optional*__
**nodePublishSecretRef**?🔹 | <code>[k8s.LocalObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-localobjectreference)</code> | NodePublishSecretRef is a reference to the secret object containing sensitive information to pass to the CSI driver to complete the CSI NodePublishVolume and NodeUnpublishVolume calls.<br/>__*Optional*__
...
## struct CustomResourceColumnDefinition 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-customresourcecolumndefinition"></a>
...
## struct CustomResourceConversion 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-customresourceconversion"></a>
...
**webhookClientConfig**?🔹 | <code>[k8s.WebhookClientConfig](#opencdk8s-cdk8s-argo-rollout-k8s-webhookclientconfig)</code> | `webhookClientConfig` is the instructions for how to call the webhook if strategy is `Webhook`.<br/>__*Optional*__



## struct CustomResourceDefinitionNames 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-customresourcedefinitionnames"></a>
...
## struct CustomResourceDefinitionSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-customresourcedefinitionspec"></a>
...
**names**🔹 | <code>[k8s.CustomResourceDefinitionNames](#opencdk8s-cdk8s-argo-rollout-k8s-customresourcedefinitionnames)</code> | Names are the names used to describe this custom resource.
**scope**🔹 | <code>string</code> | Scope indicates whether this resource is cluster or namespace scoped.
**additionalPrinterColumns**?🔹 | <code>Array<[k8s.CustomResourceColumnDefinition](#opencdk8s-cdk8s-argo-rollout-k8s-customresourcecolumndefinition)></code> | AdditionalPrinterColumns are additional columns shown e.g. in kubectl next to the name. Defaults to a created-at column. Optional, the global columns for all versions. Top-level and per-version columns are mutually exclusive.<br/>__*Default*__: a created-at column. Optional, the global columns for all versions. Top-level and per-version columns are mutually exclusive.
**conversion**?🔹 | <code>[k8s.CustomResourceConversion](#opencdk8s-cdk8s-argo-rollout-k8s-customresourceconversion)</code> | `conversion` defines conversion settings for the CRD.<br/>__*Optional*__
...
**subresources**?🔹 | <code>[k8s.CustomResourceSubresources](#opencdk8s-cdk8s-argo-rollout-k8s-customresourcesubresources)</code> | Subresources describes the subresources for CustomResource Optional, the global subresources for all versions.<br/>__*Optional*__
**validation**?🔹 | <code>[k8s.CustomResourceValidation](#opencdk8s-cdk8s-argo-rollout-k8s-customresourcevalidation)</code> | Validation describes the validation methods for CustomResources Optional, the global validation schema for all versions.<br/>__*Optional*__
...
**versions**?🔹 | <code>Array<[k8s.CustomResourceDefinitionVersion](#opencdk8s-cdk8s-argo-rollout-k8s-customresourcedefinitionversion)></code> | Versions is the list of all supported versions for this resource.<br/>__*Optional*__



## struct CustomResourceDefinitionVersion 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-customresourcedefinitionversion"></a>
...
**schema**?🔹 | <code>[k8s.CustomResourceValidation](#opencdk8s-cdk8s-argo-rollout-k8s-customresourcevalidation)</code> | Schema describes the schema for CustomResource used in validation, pruning, and defaulting.<br/>__*Optional*__
**subresources**?🔹 | <code>[k8s.CustomResourceSubresources](#opencdk8s-cdk8s-argo-rollout-k8s-customresourcesubresources)</code> | Subresources describes the subresources for CustomResource Top-level and per-version subresources are mutually exclusive.<br/>__*Optional*__



## struct CustomResourceSubresourceScale 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-customresourcesubresourcescale"></a>
...
## struct CustomResourceSubresources 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-customresourcesubresources"></a>
...
Name | Type | Description 
-----|------|-------------
**scale**?🔹 | <code>[k8s.CustomResourceSubresourceScale](#opencdk8s-cdk8s-argo-rollout-k8s-customresourcesubresourcescale)</code> | Scale denotes the scale subresource for CustomResources.<br/>__*Optional*__
**status**?🔹 | <code>any</code> | Status denotes the status subresource for CustomResources.<br/>__*Optional*__



## struct CustomResourceValidation 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-customresourcevalidation"></a>
...
Name | Type | Description 
-----|------|-------------
**openAPIV3Schema**?🔹 | <code>[k8s.JsonSchemaProps](#opencdk8s-cdk8s-argo-rollout-k8s-jsonschemaprops)</code> | OpenAPIV3Schema is the OpenAPI v3 schema to be validated against.<br/>__*Optional*__



## struct DaemonSetSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-daemonsetspec"></a>
...
Name | Type | Description 
-----|------|-------------
**template**🔹 | <code>[k8s.PodTemplateSpec](#opencdk8s-cdk8s-argo-rollout-k8s-podtemplatespec)</code> | An object that describes the pod that will be created.
...
**selector**?🔹 | <code>[k8s.LabelSelector](#opencdk8s-cdk8s-argo-rollout-k8s-labelselector)</code> | A label query over pods that are managed by the daemon set.<br/>__*Optional*__
**templateGeneration**?🔹 | <code>number</code> | DEPRECATED.<br/>__*Optional*__
**updateStrategy**?🔹 | <code>[k8s.DaemonSetUpdateStrategy](#opencdk8s-cdk8s-argo-rollout-k8s-daemonsetupdatestrategy)</code> | An update strategy to replace existing DaemonSet pods with new pods.<br/>__*Optional*__



## struct DaemonSetUpdateStrategy 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-daemonsetupdatestrategy"></a>
...
Name | Type | Description 
-----|------|-------------
**rollingUpdate**?🔹 | <code>[k8s.RollingUpdateDaemonSet](#opencdk8s-cdk8s-argo-rollout-k8s-rollingupdatedaemonset)</code> | Rolling update config params.<br/>__*Optional*__
**type**?🔹 | <code>string</code> | Type of daemon set update.<br/>__*Default*__: OnDelete.



## struct DeleteOptions 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-deleteoptions"></a>
...
**kind**?🔹 | <code>[k8s.IoK8SApimachineryPkgApisMetaV1DeleteOptionsKind](#opencdk8s-cdk8s-argo-rollout-k8s-iok8sapimachinerypkgapismetav1deleteoptionskind)</code> | Kind is a string value representing the REST resource this object represents.<br/>__*Optional*__
...
**preconditions**?🔹 | <code>[k8s.Preconditions](#opencdk8s-cdk8s-argo-rollout-k8s-preconditions)</code> | Must be fulfilled before a deletion is carried out.<br/>__*Optional*__
**propagationPolicy**?🔹 | <code>string</code> | Whether and how garbage collection will be performed.<br/>__*Optional*__



## struct DeploymentSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-deploymentspec"></a>
...
Name | Type | Description 
-----|------|-------------
**selector**🔹 | <code>[k8s.LabelSelector](#opencdk8s-cdk8s-argo-rollout-k8s-labelselector)</code> | Label selector for pods.
**template**🔹 | <code>[k8s.PodTemplateSpec](#opencdk8s-cdk8s-argo-rollout-k8s-podtemplatespec)</code> | Template describes the pods that will be created.
...
**strategy**?🔹 | <code>[k8s.DeploymentStrategy](#opencdk8s-cdk8s-argo-rollout-k8s-deploymentstrategy)</code> | The deployment strategy to use to replace existing pods with new ones.<br/>__*Optional*__



## struct DeploymentStrategy 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-deploymentstrategy"></a>
...
Name | Type | Description 
-----|------|-------------
**rollingUpdate**?🔹 | <code>[k8s.RollingUpdateDeployment](#opencdk8s-cdk8s-argo-rollout-k8s-rollingupdatedeployment)</code> | Rolling update config params.<br/>__*Optional*__
**type**?🔹 | <code>string</code> | Type of deployment.<br/>__*Default*__: RollingUpdate.



## struct DownwardApiProjection 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-downwardapiprojection"></a>
...
Name | Type | Description 
-----|------|-------------
**items**?🔹 | <code>Array<[k8s.DownwardApiVolumeFile](#opencdk8s-cdk8s-argo-rollout-k8s-downwardapivolumefile)></code> | Items is a list of DownwardAPIVolume file.<br/>__*Optional*__



## struct DownwardApiVolumeFile 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-downwardapivolumefile"></a>
...
**fieldRef**?🔹 | <code>[k8s.ObjectFieldSelector](#opencdk8s-cdk8s-argo-rollout-k8s-objectfieldselector)</code> | Required: Selects a field of the pod: only annotations, labels, name and namespace are supported.<br/>__*Optional*__
**mode**?🔹 | <code>number</code> | Optional: mode bits to use on this file, must be a value between 0 and 0777.<br/>__*Optional*__
**resourceFieldRef**?🔹 | <code>[k8s.ResourceFieldSelector](#opencdk8s-cdk8s-argo-rollout-k8s-resourcefieldselector)</code> | Selects a resource of the container: only resources limits and requests (limits.cpu, limits.memory, requests.cpu and requests.memory) are currently supported.<br/>__*Optional*__



## struct DownwardApiVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-downwardapivolumesource"></a>
...
-----|------|-------------
**defaultMode**?🔹 | <code>number</code> | Optional: mode bits to use on created files by default.<br/>__*Default*__: 0644. Directories within the path are not affected by this setting. This might be in conflict with other options that affect the file mode, like fsGroup, and the result can be other mode bits set.
**items**?🔹 | <code>Array<[k8s.DownwardApiVolumeFile](#opencdk8s-cdk8s-argo-rollout-k8s-downwardapivolumefile)></code> | Items is a list of downward API volume file.<br/>__*Optional*__



## struct EmptyDirVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-emptydirvolumesource"></a>
...
**sizeLimit**?🔹 | <code>[k8s.Quantity](#opencdk8s-cdk8s-argo-rollout-k8s-quantity)</code> | Total amount of local storage required for this EmptyDir volume.<br/>__*Optional*__



## struct EndpointAddress 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-endpointaddress"></a>
...
**targetRef**?🔹 | <code>[k8s.ObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-objectreference)</code> | Reference to object providing the endpoint.<br/>__*Optional*__



## struct EndpointPort 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-endpointport"></a>
...
## struct EndpointSubset 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-endpointsubset"></a>
...
Name | Type | Description 
-----|------|-------------
**addresses**?🔹 | <code>Array<[k8s.EndpointAddress](#opencdk8s-cdk8s-argo-rollout-k8s-endpointaddress)></code> | IP addresses which offer the related ports that are marked as ready.<br/>__*Optional*__
**notReadyAddresses**?🔹 | <code>Array<[k8s.EndpointAddress](#opencdk8s-cdk8s-argo-rollout-k8s-endpointaddress)></code> | IP addresses which offer the related ports but are not currently marked as ready because they have not yet finished starting, have recently failed a readiness check, or have recently failed a liveness check.<br/>__*Optional*__
**ports**?🔹 | <code>Array<[k8s.EndpointPort](#opencdk8s-cdk8s-argo-rollout-k8s-endpointport)></code> | Port numbers available on the related IP addresses.<br/>__*Optional*__



## struct EnvFromSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-envfromsource"></a>
...
Name | Type | Description 
-----|------|-------------
**configMapRef**?🔹 | <code>[k8s.ConfigMapEnvSource](#opencdk8s-cdk8s-argo-rollout-k8s-configmapenvsource)</code> | The ConfigMap to select from.<br/>__*Optional*__
**prefix**?🔹 | <code>string</code> | An optional identifier to prepend to each key in the ConfigMap.<br/>__*Optional*__
**secretRef**?🔹 | <code>[k8s.SecretEnvSource](#opencdk8s-cdk8s-argo-rollout-k8s-secretenvsource)</code> | The Secret to select from.<br/>__*Optional*__



## struct EnvVar 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-envvar"></a>
...
**valueFrom**?🔹 | <code>[k8s.EnvVarSource](#opencdk8s-cdk8s-argo-rollout-k8s-envvarsource)</code> | Source for the environment variable's value.<br/>__*Optional*__



## struct EnvVarSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-envvarsource"></a>
...
Name | Type | Description 
-----|------|-------------
**configMapKeyRef**?🔹 | <code>[k8s.ConfigMapKeySelector](#opencdk8s-cdk8s-argo-rollout-k8s-configmapkeyselector)</code> | Selects a key of a ConfigMap.<br/>__*Optional*__
**fieldRef**?🔹 | <code>[k8s.ObjectFieldSelector](#opencdk8s-cdk8s-argo-rollout-k8s-objectfieldselector)</code> | Selects a field of the pod: supports metadata.name, metadata.namespace, metadata.labels, metadata.annotations, spec.nodeName, spec.serviceAccountName, status.hostIP, status.podIP.<br/>__*Optional*__
**resourceFieldRef**?🔹 | <code>[k8s.ResourceFieldSelector](#opencdk8s-cdk8s-argo-rollout-k8s-resourcefieldselector)</code> | Selects a resource of the container: only resources limits and requests (limits.cpu, limits.memory, limits.ephemeral-storage, requests.cpu, requests.memory and requests.ephemeral-storage) are currently supported.<br/>__*Optional*__
**secretKeyRef**?🔹 | <code>[k8s.SecretKeySelector](#opencdk8s-cdk8s-argo-rollout-k8s-secretkeyselector)</code> | Selects a key of a secret in the pod's namespace.<br/>__*Optional*__



## struct EventSeries 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-eventseries"></a>
...
## struct EventSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-eventsource"></a>
...
## struct ExecAction 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-execaction"></a>
...
## struct ExternalDocumentation 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-externaldocumentation"></a>
...
## struct ExternalMetricSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-externalmetricsource"></a>
...
Name | Type | Description 
-----|------|-------------
**metric**🔹 | <code>[k8s.MetricIdentifier](#opencdk8s-cdk8s-argo-rollout-k8s-metricidentifier)</code> | metric identifies the target metric by name and selector.
**target**🔹 | <code>[k8s.MetricTarget](#opencdk8s-cdk8s-argo-rollout-k8s-metrictarget)</code> | target specifies the target value for the given metric.



## struct FcVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-fcvolumesource"></a>
...
## struct FlexPersistentVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-flexpersistentvolumesource"></a>
...
**readOnly**?🔹 | <code>boolean</code> | Optional: Defaults to false (read/write).<br/>__*Default*__: false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts.
**secretRef**?🔹 | <code>[k8s.SecretReference](#opencdk8s-cdk8s-argo-rollout-k8s-secretreference)</code> | Optional: SecretRef is reference to the secret object containing sensitive information to pass to the plugin scripts.<br/>__*Optional*__



## struct FlexVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-flexvolumesource"></a>
...
**options**?🔹 | <code>Map<string, string></code> | Optional: Extra command options if any.<br/>__*Optional*__
**readOnly**?🔹 | <code>boolean</code> | Optional: Defaults to false (read/write).<br/>__*Default*__: false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts.
**secretRef**?🔹 | <code>[k8s.LocalObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-localobjectreference)</code> | Optional: SecretRef is reference to the secret object containing sensitive information to pass to the plugin scripts.<br/>__*Optional*__



## struct FlockerVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-flockervolumesource"></a>
...
## struct FsGroupStrategyOptions 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-fsgroupstrategyoptions"></a>
...
Name | Type | Description 
-----|------|-------------
**ranges**?🔹 | <code>Array<[k8s.IdRange](#opencdk8s-cdk8s-argo-rollout-k8s-idrange)></code> | ranges are the allowed ranges of fs groups.<br/>__*Optional*__
...
## struct GcePersistentDiskVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-gcepersistentdiskvolumesource"></a>
...
## struct GitRepoVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-gitrepovolumesource"></a>
...
## struct GlusterfsPersistentVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-glusterfspersistentvolumesource"></a>
...
## struct GlusterfsVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-glusterfsvolumesource"></a>
...
## struct Handler 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-handler"></a>
...
Name | Type | Description 
-----|------|-------------
**exec**?🔹 | <code>[k8s.ExecAction](#opencdk8s-cdk8s-argo-rollout-k8s-execaction)</code> | One and only one of the following should be specified.<br/>__*Optional*__
**httpGet**?🔹 | <code>[k8s.HttpGetAction](#opencdk8s-cdk8s-argo-rollout-k8s-httpgetaction)</code> | HTTPGet specifies the http request to perform.<br/>__*Optional*__
**tcpSocket**?🔹 | <code>[k8s.TcpSocketAction](#opencdk8s-cdk8s-argo-rollout-k8s-tcpsocketaction)</code> | TCPSocket specifies an action involving a TCP port.<br/>__*Optional*__



## struct HorizontalPodAutoscalerSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-horizontalpodautoscalerspec"></a>
...
**scaleTargetRef**🔹 | <code>[k8s.CrossVersionObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-crossversionobjectreference)</code> | scaleTargetRef points to the target resource to scale, and is used to the pods for which metrics should be collected, as well as to actually change the replica count.
**metrics**?🔹 | <code>Array<[k8s.MetricSpec](#opencdk8s-cdk8s-argo-rollout-k8s-metricspec)></code> | metrics contains the specifications for which to use to calculate the desired replica count (the maximum replica count across all metrics will be used).<br/>__*Optional*__
...
## struct HostAlias 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-hostalias"></a>
...
## struct HostPathVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-hostpathvolumesource"></a>
...
## struct HostPortRange 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-hostportrange"></a>
...
## struct HttpGetAction 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-httpgetaction"></a>
...
Name | Type | Description 
-----|------|-------------
**port**🔹 | <code>[k8s.IntOrString](#opencdk8s-cdk8s-argo-rollout-k8s-intorstring)</code> | Name or number of the port to access on the container.
**host**?🔹 | <code>string</code> | Host name to connect to, defaults to the pod IP.<br/>__*Optional*__
**httpHeaders**?🔹 | <code>Array<[k8s.HttpHeader](#opencdk8s-cdk8s-argo-rollout-k8s-httpheader)></code> | Custom headers to set in the request.<br/>__*Optional*__
...
## struct HttpHeader 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-httpheader"></a>
...
## struct HttpIngressPath 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-httpingresspath"></a>
...
Name | Type | Description 
-----|------|-------------
**backend**🔹 | <code>[k8s.IngressBackend](#opencdk8s-cdk8s-argo-rollout-k8s-ingressbackend)</code> | Backend defines the referenced service endpoint to which the traffic will be forwarded to.
...
## struct HttpIngressRuleValue 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-httpingressrulevalue"></a>
...
Name | Type | Description 
-----|------|-------------
**paths**🔹 | <code>Array<[k8s.HttpIngressPath](#opencdk8s-cdk8s-argo-rollout-k8s-httpingresspath)></code> | A collection of paths that map requests to backends.



## struct IdRange 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-idrange"></a>
...
## struct IngressBackend 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-ingressbackend"></a>
...
**servicePort**🔹 | <code>[k8s.IntOrString](#opencdk8s-cdk8s-argo-rollout-k8s-intorstring)</code> | Specifies the port of the referenced service.



## struct IngressRule 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-ingressrule"></a>
...
**http**?🔹 | <code>[k8s.HttpIngressRuleValue](#opencdk8s-cdk8s-argo-rollout-k8s-httpingressrulevalue)</code> | __*Optional*__



## struct IngressSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-ingressspec"></a>
...
Name | Type | Description 
-----|------|-------------
**backend**?🔹 | <code>[k8s.IngressBackend](#opencdk8s-cdk8s-argo-rollout-k8s-ingressbackend)</code> | A default backend capable of servicing requests that don't match any rule.<br/>__*Optional*__
**rules**?🔹 | <code>Array<[k8s.IngressRule](#opencdk8s-cdk8s-argo-rollout-k8s-ingressrule)></code> | A list of host rules used to configure the Ingress.<br/>__*Optional*__
**tls**?🔹 | <code>Array<[k8s.IngressTls](#opencdk8s-cdk8s-argo-rollout-k8s-ingresstls)></code> | TLS configuration.<br/>__*Optional*__



## struct IngressTls 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-ingresstls"></a>
...
## struct Initializer 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-initializer"></a>
...
## struct Initializers 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-initializers"></a>
...
Name | Type | Description 
-----|------|-------------
**pending**🔹 | <code>Array<[k8s.Initializer](#opencdk8s-cdk8s-argo-rollout-k8s-initializer)></code> | Pending is a list of initializers that must execute in order before this object is visible.
**result**?🔹 | <code>[k8s.KubeStatusProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubestatusprops)</code> | If result is set with the Failure field, the object will be persisted to storage and then deleted, ensuring that other clients can observe the deletion.<br/>__*Optional*__



## struct IpBlock 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-ipblock"></a>
...
## struct IscsiPersistentVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-iscsipersistentvolumesource"></a>
...
**secretRef**?🔹 | <code>[k8s.SecretReference](#opencdk8s-cdk8s-argo-rollout-k8s-secretreference)</code> | CHAP Secret for iSCSI target and initiator authentication.<br/>__*Optional*__



## struct IscsiVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-iscsivolumesource"></a>
...
**portals**?🔹 | <code>Array<string></code> | iSCSI Target Portal List.<br/>__*Optional*__
**readOnly**?🔹 | <code>boolean</code> | ReadOnly here will force the ReadOnly setting in VolumeMounts.<br/>__*Default*__: false.
**secretRef**?🔹 | <code>[k8s.LocalObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-localobjectreference)</code> | CHAP Secret for iSCSI target and initiator authentication.<br/>__*Optional*__



## struct JobSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-jobspec"></a>
...
Name | Type | Description 
-----|------|-------------
**template**🔹 | <code>[k8s.PodTemplateSpec](#opencdk8s-cdk8s-argo-rollout-k8s-podtemplatespec)</code> | Describes the pod that will be created when executing a job.
...
**selector**?🔹 | <code>[k8s.LabelSelector](#opencdk8s-cdk8s-argo-rollout-k8s-labelselector)</code> | A label query over pods that should match the pod count.<br/>__*Optional*__
...
## struct JobTemplateSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-jobtemplatespec"></a>
...
Name | Type | Description 
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata of the jobs created from this template.<br/>__*Optional*__
**spec**?🔹 | <code>[k8s.JobSpec](#opencdk8s-cdk8s-argo-rollout-k8s-jobspec)</code> | Specification of the desired behavior of the job.<br/>__*Optional*__



## struct JsonSchemaProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-jsonschemaprops"></a>
...
**allOf**?🔹 | <code>Array<[k8s.JsonSchemaProps](#opencdk8s-cdk8s-argo-rollout-k8s-jsonschemaprops)></code> | __*Optional*__
**anyOf**?🔹 | <code>Array<[k8s.JsonSchemaProps](#opencdk8s-cdk8s-argo-rollout-k8s-jsonschemaprops)></code> | __*Optional*__
**default**?🔹 | <code>any</code> | default is a default value for undefined object fields.<br/>__*Optional*__
**definitions**?🔹 | <code>Map<string, [k8s.JsonSchemaProps](#opencdk8s-cdk8s-argo-rollout-k8s-jsonschemaprops)></code> | __*Optional*__
...
**externalDocs**?🔹 | <code>[k8s.ExternalDocumentation](#opencdk8s-cdk8s-argo-rollout-k8s-externaldocumentation)</code> | __*Optional*__
...
**not**?🔹 | <code>[k8s.JsonSchemaProps](#opencdk8s-cdk8s-argo-rollout-k8s-jsonschemaprops)</code> | __*Optional*__
**nullable**?🔹 | <code>boolean</code> | __*Optional*__
**oneOf**?🔹 | <code>Array<[k8s.JsonSchemaProps](#opencdk8s-cdk8s-argo-rollout-k8s-jsonschemaprops)></code> | __*Optional*__
**pattern**?🔹 | <code>string</code> | __*Optional*__
**patternProperties**?🔹 | <code>Map<string, [k8s.JsonSchemaProps](#opencdk8s-cdk8s-argo-rollout-k8s-jsonschemaprops)></code> | __*Optional*__
**properties**?🔹 | <code>Map<string, [k8s.JsonSchemaProps](#opencdk8s-cdk8s-argo-rollout-k8s-jsonschemaprops)></code> | __*Optional*__
...
## struct KeyToPath 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-keytopath"></a>
...
## struct KubeApiServiceListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeapiservicelistprops"></a>
...
Name | Type | Description 
-----|------|-------------
**items**🔹 | <code>Array<[k8s.KubeApiServiceProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeapiserviceprops)></code> | <span></span>
**metadata**?🔹 | <code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code> | __*Optional*__



## struct KubeApiServiceListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeapiservicelistv1beta1props"></a>
...
Name | Type | Description 
-----|------|-------------
**items**🔹 | <code>Array<[k8s.KubeApiServiceV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubeapiservicev1beta1props)></code> | <span></span>
**metadata**?🔹 | <code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code> | __*Optional*__



## struct KubeApiServiceProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeapiserviceprops"></a>
...
Name | Type | Description 
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | __*Optional*__
**spec**?🔹 | <code>[k8s.ApiServiceSpec](#opencdk8s-cdk8s-argo-rollout-k8s-apiservicespec)</code> | Spec contains information for locating and communicating with a server.<br/>__*Optional*__



## struct KubeApiServiceV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeapiservicev1beta1props"></a>
...
## struct KubeAuditSinkListV1Alpha1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeauditsinklistv1alpha1props"></a>
...
## struct KubeAuditSinkV1Alpha1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeauditsinkv1alpha1props"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | __*Optional*__
**spec**?🔹 | <code>[k8s.AuditSinkSpec](#opencdk8s-cdk8s-argo-rollout-k8s-auditsinkspec)</code> | Spec defines the audit configuration spec.<br/>__*Optional*__



## struct KubeBindingProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubebindingprops"></a>
...
## struct KubeCertificateSigningRequestListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecertificatesigningrequestlistv1beta1props"></a>
...
Name | Type | Description 
-----|------|-------------
**items**🔹 | <code>Array<[k8s.KubeCertificateSigningRequestV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecertificatesigningrequestv1beta1props)></code> | <span></span>
**metadata**?🔹 | <code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code> | __*Optional*__



## struct KubeCertificateSigningRequestV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecertificatesigningrequestv1beta1props"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | __*Optional*__
**spec**?🔹 | <code>[k8s.CertificateSigningRequestSpec](#opencdk8s-cdk8s-argo-rollout-k8s-certificatesigningrequestspec)</code> | The certificate request itself and any additional information.<br/>__*Optional*__



## struct KubeClusterRoleBindingListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindinglistprops"></a>
...
-----|------|-------------
**items**🔹 | <code>Array<[k8s.KubeClusterRoleBindingProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindingprops)></code> | Items is a list of ClusterRoleBindings.
**metadata**?🔹 | <code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code> | Standard object's metadata.<br/>__*Optional*__



## struct KubeClusterRoleBindingListV1Alpha1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindinglistv1alpha1props"></a>
...
## struct KubeClusterRoleBindingListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindinglistv1beta1props"></a>
...
## struct KubeClusterRoleBindingProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindingprops"></a>
...
**roleRef**🔹 | <code>[k8s.RoleRef](#opencdk8s-cdk8s-argo-rollout-k8s-roleref)</code> | RoleRef can only reference a ClusterRole in the global namespace.
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__
**subjects**?🔹 | <code>Array<[k8s.Subject](#opencdk8s-cdk8s-argo-rollout-k8s-subject)></code> | Subjects holds references to the objects the role applies to.<br/>__*Optional*__



## struct KubeClusterRoleBindingV1Alpha1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindingv1alpha1props"></a>
...
## struct KubeClusterRoleBindingV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolebindingv1beta1props"></a>
...
## struct KubeClusterRoleListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolelistprops"></a>
...
## struct KubeClusterRoleListV1Alpha1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolelistv1alpha1props"></a>
...
## struct KubeClusterRoleListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolelistv1beta1props"></a>
...
## struct KubeClusterRoleProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterroleprops"></a>
...
Name | Type | Description 
-----|------|-------------
**aggregationRule**?🔹 | <code>[k8s.AggregationRule](#opencdk8s-cdk8s-argo-rollout-k8s-aggregationrule)</code> | AggregationRule is an optional field that describes how to build the Rules for this ClusterRole.<br/>__*Optional*__
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__
**rules**?🔹 | <code>Array<[k8s.PolicyRule](#opencdk8s-cdk8s-argo-rollout-k8s-policyrule)></code> | Rules holds all the PolicyRules for this ClusterRole.<br/>__*Optional*__



## struct KubeClusterRoleV1Alpha1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolev1alpha1props"></a>
...
## struct KubeClusterRoleV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeclusterrolev1beta1props"></a>
...
## struct KubeComponentStatusListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecomponentstatuslistprops"></a>
...
-----|------|-------------
**items**🔹 | <code>Array<[k8s.KubeComponentStatusProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubecomponentstatusprops)></code> | List of ComponentStatus objects.
**metadata**?🔹 | <code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code> | Standard list metadata.<br/>__*Optional*__



## struct KubeComponentStatusProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecomponentstatusprops"></a>
...
Name | Type | Description 
-----|------|-------------
**conditions**?🔹 | <code>Array<[k8s.ComponentCondition](#opencdk8s-cdk8s-argo-rollout-k8s-componentcondition)></code> | List of component conditions observed.<br/>__*Optional*__
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__



## struct KubeConfigMapListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeconfigmaplistprops"></a>
...
-----|------|-------------
**items**🔹 | <code>Array<[k8s.KubeConfigMapProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubeconfigmapprops)></code> | Items is the list of ConfigMaps.
**metadata**?🔹 | <code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code> | More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata.<br/>__*Optional*__



## struct KubeConfigMapProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeconfigmapprops"></a>
...
## struct KubeControllerRevisionListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionlistprops"></a>
...
## struct KubeControllerRevisionListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionlistv1beta1props"></a>
...
## struct KubeControllerRevisionListV1Beta2Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionlistv1beta2props"></a>
...
-----|------|-------------
**items**🔹 | <code>Array<[k8s.KubeControllerRevisionV1Beta2Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionv1beta2props)></code> | Items is the list of ControllerRevisions.
**metadata**?🔹 | <code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code> | More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata.<br/>__*Optional*__



## struct KubeControllerRevisionProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionprops"></a>
...
-----|------|-------------
**revision**🔹 | <code>number</code> | Revision indicates the revision of the state represented by Data.
**data**?🔹 | <code>[k8s.RawExtension](#opencdk8s-cdk8s-argo-rollout-k8s-rawextension)</code> | Data is the serialized representation of the state.<br/>__*Optional*__
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__



## struct KubeControllerRevisionV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionv1beta1props"></a>
...
## struct KubeControllerRevisionV1Beta2Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecontrollerrevisionv1beta2props"></a>
...
## struct KubeCronJobListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecronjoblistv1beta1props"></a>
...
## struct KubeCronJobListV2Alpha1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecronjoblistv2alpha1props"></a>
...
## struct KubeCronJobV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecronjobv1beta1props"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__
**spec**?🔹 | <code>[k8s.CronJobSpec](#opencdk8s-cdk8s-argo-rollout-k8s-cronjobspec)</code> | Specification of the desired behavior of a cron job, including the schedule.<br/>__*Optional*__



## struct KubeCronJobV2Alpha1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecronjobv2alpha1props"></a>
...
## struct KubeCsiDriverListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecsidriverlistv1beta1props"></a>
...
-----|------|-------------
**items**🔹 | <code>Array<[k8s.KubeCsiDriverV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubecsidriverv1beta1props)></code> | items is the list of CSIDriver.
**metadata**?🔹 | <code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code> | Standard list metadata More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata.<br/>__*Optional*__



## struct KubeCsiDriverV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecsidriverv1beta1props"></a>
...
-----|------|-------------
**spec**🔹 | <code>[k8s.CsiDriverSpec](#opencdk8s-cdk8s-argo-rollout-k8s-csidriverspec)</code> | Specification of the CSI Driver.
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object metadata.<br/>__*Optional*__



## struct KubeCsiNodeListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecsinodelistv1beta1props"></a>
...
## struct KubeCsiNodeV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecsinodev1beta1props"></a>
...
-----|------|-------------
**spec**🔹 | <code>[k8s.CsiNodeSpec](#opencdk8s-cdk8s-argo-rollout-k8s-csinodespec)</code> | spec is the specification of CSINode.
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | metadata.name must be the Kubernetes node name.<br/>__*Optional*__



## struct KubeCustomResourceDefinitionListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecustomresourcedefinitionlistv1beta1props"></a>
...
## struct KubeCustomResourceDefinitionV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubecustomresourcedefinitionv1beta1props"></a>
...
## struct KubeDaemonSetListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetlistprops"></a>
...
## struct KubeDaemonSetListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetlistv1beta1props"></a>
...
## struct KubeDaemonSetListV1Beta2Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetlistv1beta2props"></a>
...
## struct KubeDaemonSetProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetprops"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__
**spec**?🔹 | <code>[k8s.DaemonSetSpec](#opencdk8s-cdk8s-argo-rollout-k8s-daemonsetspec)</code> | The desired behavior of this daemon set.<br/>__*Optional*__



## struct KubeDaemonSetV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetv1beta1props"></a>
...
## struct KubeDaemonSetV1Beta2Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedaemonsetv1beta2props"></a>
...
## struct KubeDeploymentListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentlistprops"></a>
...
## struct KubeDeploymentListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentlistv1beta1props"></a>
...
## struct KubeDeploymentListV1Beta2Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentlistv1beta2props"></a>
...
## struct KubeDeploymentProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentprops"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object metadata.<br/>__*Optional*__
**spec**?🔹 | <code>[k8s.DeploymentSpec](#opencdk8s-cdk8s-argo-rollout-k8s-deploymentspec)</code> | Specification of the desired behavior of the Deployment.<br/>__*Optional*__



## struct KubeDeploymentV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentv1beta1props"></a>
...
## struct KubeDeploymentV1Beta2Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubedeploymentv1beta2props"></a>
...
## struct KubeEndpointsListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeendpointslistprops"></a>
...
## struct KubeEndpointsProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeendpointsprops"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__
**subsets**?🔹 | <code>Array<[k8s.EndpointSubset](#opencdk8s-cdk8s-argo-rollout-k8s-endpointsubset)></code> | The set of all endpoints is the union of all subsets.<br/>__*Optional*__



## struct KubeEventListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeeventlistprops"></a>
...
## struct KubeEventListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeeventlistv1beta1props"></a>
...
## struct KubeEventProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeeventprops"></a>
...
**related**?🔹 | <code>[k8s.ObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-objectreference)</code> | Optional secondary object for more complex actions.<br/>__*Optional*__
...
**series**?🔹 | <code>[k8s.EventSeries](#opencdk8s-cdk8s-argo-rollout-k8s-eventseries)</code> | Data about the Event series this event represents or nil if it's a singleton Event.<br/>__*Optional*__
**source**?🔹 | <code>[k8s.EventSource](#opencdk8s-cdk8s-argo-rollout-k8s-eventsource)</code> | The component reporting this event.<br/>__*Optional*__
**type**?🔹 | <code>string</code> | Type of this event (Normal, Warning), new types could be added in the future.<br/>__*Optional*__



## struct KubeEventV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeeventv1beta1props"></a>
...
**deprecatedSource**?🔹 | <code>[k8s.EventSource](#opencdk8s-cdk8s-argo-rollout-k8s-eventsource)</code> | Deprecated field assuring backward compatibility with core.v1 Event type.<br/>__*Optional*__
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | __*Optional*__
**note**?🔹 | <code>string</code> | Optional.<br/>__*Optional*__
**reason**?🔹 | <code>string</code> | Why the action was taken.<br/>__*Optional*__
**regarding**?🔹 | <code>[k8s.ObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-objectreference)</code> | The object this Event is about.<br/>__*Optional*__
**related**?🔹 | <code>[k8s.ObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-objectreference)</code> | Optional secondary object for more complex actions.<br/>__*Optional*__
...
## struct KubeEvictionV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeevictionv1beta1props"></a>
...
Name | Type | Description 
-----|------|-------------
**deleteOptions**?🔹 | <code>[k8s.DeleteOptions](#opencdk8s-cdk8s-argo-rollout-k8s-deleteoptions)</code> | DeleteOptions may be provided.<br/>__*Optional*__
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | ObjectMeta describes the pod that is being evicted.<br/>__*Optional*__



## struct KubeHorizontalPodAutoscalerListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerlistprops"></a>
...
## struct KubeHorizontalPodAutoscalerListV2Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerlistv2beta1props"></a>
...
-----|------|-------------
**items**🔹 | <code>Array<[k8s.KubeHorizontalPodAutoscalerV2Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerv2beta1props)></code> | items is the list of horizontal pod autoscaler objects.
**metadata**?🔹 | <code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code> | metadata is the standard list metadata.<br/>__*Optional*__



## struct KubeHorizontalPodAutoscalerListV2Beta2Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerlistv2beta2props"></a>
...
## struct KubeHorizontalPodAutoscalerProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerprops"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object metadata.<br/>__*Optional*__
**spec**?🔹 | <code>[k8s.HorizontalPodAutoscalerSpec](#opencdk8s-cdk8s-argo-rollout-k8s-horizontalpodautoscalerspec)</code> | behaviour of autoscaler.<br/>__*Optional*__



## struct KubeHorizontalPodAutoscalerV2Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerv2beta1props"></a>
...
Name | Type | Description 
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | metadata is the standard object metadata.<br/>__*Optional*__
**spec**?🔹 | <code>[k8s.HorizontalPodAutoscalerSpec](#opencdk8s-cdk8s-argo-rollout-k8s-horizontalpodautoscalerspec)</code> | spec is the specification for the behaviour of the autoscaler.<br/>__*Optional*__



## struct KubeHorizontalPodAutoscalerV2Beta2Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubehorizontalpodautoscalerv2beta2props"></a>
...
## struct KubeIngressListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeingresslistv1beta1props"></a>
...
## struct KubeIngressV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeingressv1beta1props"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__
**spec**?🔹 | <code>[k8s.IngressSpec](#opencdk8s-cdk8s-argo-rollout-k8s-ingressspec)</code> | Spec is the desired state of the Ingress.<br/>__*Optional*__



## struct KubeJobListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubejoblistprops"></a>
...
## struct KubeJobProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubejobprops"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__
**spec**?🔹 | <code>[k8s.JobSpec](#opencdk8s-cdk8s-argo-rollout-k8s-jobspec)</code> | Specification of the desired behavior of a job.<br/>__*Optional*__



## struct KubeLeaseListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeleaselistprops"></a>
...
## struct KubeLeaseListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeleaselistv1beta1props"></a>
...
## struct KubeLeaseProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeleaseprops"></a>
...
Name | Type | Description 
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata.<br/>__*Optional*__
**spec**?🔹 | <code>[k8s.LeaseSpec](#opencdk8s-cdk8s-argo-rollout-k8s-leasespec)</code> | Specification of the Lease.<br/>__*Optional*__



## struct KubeLeaseV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeleasev1beta1props"></a>
...
## struct KubeLimitRangeListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubelimitrangelistprops"></a>
...
## struct KubeLimitRangeProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubelimitrangeprops"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__
**spec**?🔹 | <code>[k8s.LimitRangeSpec](#opencdk8s-cdk8s-argo-rollout-k8s-limitrangespec)</code> | Spec defines the limits enforced.<br/>__*Optional*__



## struct KubeLocalSubjectAccessReviewProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubelocalsubjectaccessreviewprops"></a>
...
## struct KubeLocalSubjectAccessReviewV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubelocalsubjectaccessreviewv1beta1props"></a>
...
## struct KubeMutatingWebhookConfigurationListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubemutatingwebhookconfigurationlistv1beta1props"></a>
...
## struct KubeMutatingWebhookConfigurationV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubemutatingwebhookconfigurationv1beta1props"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object metadata;<br/>__*Optional*__
**webhooks**?🔹 | <code>Array<[k8s.MutatingWebhook](#opencdk8s-cdk8s-argo-rollout-k8s-mutatingwebhook)></code> | Webhooks is a list of webhooks and the affected resources and operations.<br/>__*Optional*__



## struct KubeNamespaceListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenamespacelistprops"></a>
...
## struct KubeNamespaceProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenamespaceprops"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__
**spec**?🔹 | <code>[k8s.NamespaceSpec](#opencdk8s-cdk8s-argo-rollout-k8s-namespacespec)</code> | Spec defines the behavior of the Namespace.<br/>__*Optional*__



## struct KubeNetworkPolicyListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenetworkpolicylistprops"></a>
...
## struct KubeNetworkPolicyListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenetworkpolicylistv1beta1props"></a>
...
## struct KubeNetworkPolicyProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenetworkpolicyprops"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__
**spec**?🔹 | <code>[k8s.NetworkPolicySpec](#opencdk8s-cdk8s-argo-rollout-k8s-networkpolicyspec)</code> | Specification of the desired behavior for this NetworkPolicy.<br/>__*Optional*__



## struct KubeNetworkPolicyV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenetworkpolicyv1beta1props"></a>
...
## struct KubeNodeListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenodelistprops"></a>
...
## struct KubeNodeProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubenodeprops"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__
**spec**?🔹 | <code>[k8s.NodeSpec](#opencdk8s-cdk8s-argo-rollout-k8s-nodespec)</code> | Spec defines the behavior of a node.<br/>__*Optional*__



## struct KubePersistentVolumeClaimListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepersistentvolumeclaimlistprops"></a>
...
## struct KubePersistentVolumeClaimProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepersistentvolumeclaimprops"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__
**spec**?🔹 | <code>[k8s.PersistentVolumeClaimSpec](#opencdk8s-cdk8s-argo-rollout-k8s-persistentvolumeclaimspec)</code> | Spec defines the desired characteristics of a volume requested by a pod author.<br/>__*Optional*__



## struct KubePersistentVolumeListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepersistentvolumelistprops"></a>
...
## struct KubePersistentVolumeProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepersistentvolumeprops"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__
**spec**?🔹 | <code>[k8s.PersistentVolumeSpec](#opencdk8s-cdk8s-argo-rollout-k8s-persistentvolumespec)</code> | Spec defines a specification of a persistent volume owned by the cluster.<br/>__*Optional*__



## struct KubePodDisruptionBudgetListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepoddisruptionbudgetlistv1beta1props"></a>
...
Name | Type | Description 
-----|------|-------------
**items**🔹 | <code>Array<[k8s.KubePodDisruptionBudgetV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubepoddisruptionbudgetv1beta1props)></code> | <span></span>
**metadata**?🔹 | <code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code> | __*Optional*__



## struct KubePodDisruptionBudgetV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepoddisruptionbudgetv1beta1props"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | __*Optional*__
**spec**?🔹 | <code>[k8s.PodDisruptionBudgetSpec](#opencdk8s-cdk8s-argo-rollout-k8s-poddisruptionbudgetspec)</code> | Specification of the desired behavior of the PodDisruptionBudget.<br/>__*Optional*__



## struct KubePodListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepodlistprops"></a>
...
## struct KubePodPresetListV1Alpha1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepodpresetlistv1alpha1props"></a>
...
## struct KubePodPresetV1Alpha1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepodpresetv1alpha1props"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | __*Optional*__
**spec**?🔹 | <code>[k8s.PodPresetSpec](#opencdk8s-cdk8s-argo-rollout-k8s-podpresetspec)</code> | __*Optional*__



## struct KubePodProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepodprops"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__
**spec**?🔹 | <code>[k8s.PodSpec](#opencdk8s-cdk8s-argo-rollout-k8s-podspec)</code> | Specification of the desired behavior of the pod.<br/>__*Optional*__



## struct KubePodSecurityPolicyListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepodsecuritypolicylistv1beta1props"></a>
...
## struct KubePodSecurityPolicyV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepodsecuritypolicyv1beta1props"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__
**spec**?🔹 | <code>[k8s.PodSecurityPolicySpec](#opencdk8s-cdk8s-argo-rollout-k8s-podsecuritypolicyspec)</code> | spec defines the policy enforced.<br/>__*Optional*__



## struct KubePodTemplateListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepodtemplatelistprops"></a>
...
## struct KubePodTemplateProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepodtemplateprops"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__
**template**?🔹 | <code>[k8s.PodTemplateSpec](#opencdk8s-cdk8s-argo-rollout-k8s-podtemplatespec)</code> | Template defines the pods that will be created from this pod template.<br/>__*Optional*__



## struct KubePriorityClassListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclasslistprops"></a>
...
## struct KubePriorityClassListV1Alpha1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclasslistv1alpha1props"></a>
...
## struct KubePriorityClassListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclasslistv1beta1props"></a>
...
-----|------|-------------
**items**🔹 | <code>Array<[k8s.KubePriorityClassV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclassv1beta1props)></code> | items is the list of PriorityClasses.
**metadata**?🔹 | <code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code> | Standard list metadata More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata.<br/>__*Optional*__



## struct KubePriorityClassProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclassprops"></a>
...
## struct KubePriorityClassV1Alpha1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclassv1alpha1props"></a>
...
## struct KubePriorityClassV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubepriorityclassv1beta1props"></a>
...
## struct KubeReplicaSetListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetlistprops"></a>
...
## struct KubeReplicaSetListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetlistv1beta1props"></a>
...
## struct KubeReplicaSetListV1Beta2Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetlistv1beta2props"></a>
...
## struct KubeReplicaSetProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetprops"></a>
...
Name | Type | Description 
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | If the Labels of a ReplicaSet are empty, they are defaulted to be the same as the Pod(s) that the ReplicaSet manages.<br/>__*Optional*__
**spec**?🔹 | <code>[k8s.ReplicaSetSpec](#opencdk8s-cdk8s-argo-rollout-k8s-replicasetspec)</code> | Spec defines the specification of the desired behavior of the ReplicaSet.<br/>__*Optional*__



## struct KubeReplicaSetV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetv1beta1props"></a>
...
## struct KubeReplicaSetV1Beta2Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicasetv1beta2props"></a>
...
## struct KubeReplicationControllerListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicationcontrollerlistprops"></a>
...
## struct KubeReplicationControllerProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubereplicationcontrollerprops"></a>
...
Name | Type | Description 
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | If the Labels of a ReplicationController are empty, they are defaulted to be the same as the Pod(s) that the replication controller manages.<br/>__*Optional*__
**spec**?🔹 | <code>[k8s.ReplicationControllerSpec](#opencdk8s-cdk8s-argo-rollout-k8s-replicationcontrollerspec)</code> | Spec defines the specification of the desired behavior of the replication controller.<br/>__*Optional*__



## struct KubeResourceQuotaListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberesourcequotalistprops"></a>
...
## struct KubeResourceQuotaProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberesourcequotaprops"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__
**spec**?🔹 | <code>[k8s.ResourceQuotaSpec](#opencdk8s-cdk8s-argo-rollout-k8s-resourcequotaspec)</code> | Spec defines the desired quota.<br/>__*Optional*__



## struct KubeRoleBindingListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindinglistprops"></a>
...
## struct KubeRoleBindingListV1Alpha1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindinglistv1alpha1props"></a>
...
## struct KubeRoleBindingListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindinglistv1beta1props"></a>
...
## struct KubeRoleBindingProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindingprops"></a>
...
## struct KubeRoleBindingV1Alpha1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindingv1alpha1props"></a>
...
## struct KubeRoleBindingV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolebindingv1beta1props"></a>
...
## struct KubeRoleListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolelistprops"></a>
...
## struct KubeRoleListV1Alpha1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolelistv1alpha1props"></a>
...
## struct KubeRoleListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolelistv1beta1props"></a>
...
## struct KubeRoleProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberoleprops"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__
**rules**?🔹 | <code>Array<[k8s.PolicyRule](#opencdk8s-cdk8s-argo-rollout-k8s-policyrule)></code> | Rules holds all the PolicyRules for this Role.<br/>__*Optional*__



## struct KubeRoleV1Alpha1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolev1alpha1props"></a>
...
## struct KubeRoleV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberolev1beta1props"></a>
...
## struct KubeRuntimeClassListV1Alpha1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberuntimeclasslistv1alpha1props"></a>
...
## struct KubeRuntimeClassListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberuntimeclasslistv1beta1props"></a>
...
## struct KubeRuntimeClassV1Alpha1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberuntimeclassv1alpha1props"></a>
...
## struct KubeRuntimeClassV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kuberuntimeclassv1beta1props"></a>
...
## struct KubeScaleProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubescaleprops"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object metadata;<br/>__*Optional*__
**spec**?🔹 | <code>[k8s.ScaleSpec](#opencdk8s-cdk8s-argo-rollout-k8s-scalespec)</code> | defines the behavior of the scale.<br/>__*Optional*__



## struct KubeScaleV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubescalev1beta1props"></a>
...
## struct KubeScaleV1Beta2Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubescalev1beta2props"></a>
...
## struct KubeSecretListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubesecretlistprops"></a>
...
## struct KubeSecretProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubesecretprops"></a>
...
## struct KubeSelfSubjectAccessReviewProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeselfsubjectaccessreviewprops"></a>
...
## struct KubeSelfSubjectAccessReviewV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeselfsubjectaccessreviewv1beta1props"></a>
...
## struct KubeSelfSubjectRulesReviewProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeselfsubjectrulesreviewprops"></a>
...
## struct KubeSelfSubjectRulesReviewV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeselfsubjectrulesreviewv1beta1props"></a>
...
## struct KubeServiceAccountListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeserviceaccountlistprops"></a>
...
## struct KubeServiceAccountProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeserviceaccountprops"></a>
...
**imagePullSecrets**?🔹 | <code>Array<[k8s.LocalObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-localobjectreference)></code> | ImagePullSecrets is a list of references to secrets in the same namespace to use for pulling any images in pods that reference this ServiceAccount.<br/>__*Optional*__
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__
**secrets**?🔹 | <code>Array<[k8s.ObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-objectreference)></code> | Secrets is the list of secrets allowed to be used by pods running using this ServiceAccount.<br/>__*Optional*__



## struct KubeServiceListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeservicelistprops"></a>
...
## struct KubeServiceProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubeserviceprops"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__
**spec**?🔹 | <code>[k8s.ServiceSpec](#opencdk8s-cdk8s-argo-rollout-k8s-servicespec)</code> | Spec defines the behavior of a service.<br/>__*Optional*__



## struct KubeStatefulSetListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetlistprops"></a>
...
Name | Type | Description 
-----|------|-------------
**items**🔹 | <code>Array<[k8s.KubeStatefulSetProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetprops)></code> | <span></span>
**metadata**?🔹 | <code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code> | __*Optional*__



## struct KubeStatefulSetListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetlistv1beta1props"></a>
...
Name | Type | Description 
-----|------|-------------
**items**🔹 | <code>Array<[k8s.KubeStatefulSetV1Beta1Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetv1beta1props)></code> | <span></span>
**metadata**?🔹 | <code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code> | __*Optional*__



## struct KubeStatefulSetListV1Beta2Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetlistv1beta2props"></a>
...
Name | Type | Description 
-----|------|-------------
**items**🔹 | <code>Array<[k8s.KubeStatefulSetV1Beta2Props](#opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetv1beta2props)></code> | <span></span>
**metadata**?🔹 | <code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code> | __*Optional*__



## struct KubeStatefulSetProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetprops"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | __*Optional*__
**spec**?🔹 | <code>[k8s.StatefulSetSpec](#opencdk8s-cdk8s-argo-rollout-k8s-statefulsetspec)</code> | Spec defines the desired identities of pods in this set.<br/>__*Optional*__



## struct KubeStatefulSetV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetv1beta1props"></a>
...
## struct KubeStatefulSetV1Beta2Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestatefulsetv1beta2props"></a>
...
## struct KubeStatusProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestatusprops"></a>
...
**details**?🔹 | <code>[k8s.StatusDetails](#opencdk8s-cdk8s-argo-rollout-k8s-statusdetails)</code> | Extended data associated with the reason.<br/>__*Optional*__
**message**?🔹 | <code>string</code> | A human-readable description of the status of this operation.<br/>__*Optional*__
**metadata**?🔹 | <code>[k8s.ListMeta](#opencdk8s-cdk8s-argo-rollout-k8s-listmeta)</code> | Standard list metadata.<br/>__*Optional*__
...
## struct KubeStorageClassListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestorageclasslistprops"></a>
...
## struct KubeStorageClassListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestorageclasslistv1beta1props"></a>
...
## struct KubeStorageClassProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestorageclassprops"></a>
...
**allowedTopologies**?🔹 | <code>Array<[k8s.TopologySelectorTerm](#opencdk8s-cdk8s-argo-rollout-k8s-topologyselectorterm)></code> | Restrict the node topologies where volumes can be dynamically provisioned.<br/>__*Optional*__
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object's metadata.<br/>__*Optional*__
...
## struct KubeStorageClassV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubestorageclassv1beta1props"></a>
...
## struct KubeSubjectAccessReviewProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubesubjectaccessreviewprops"></a>
...
## struct KubeSubjectAccessReviewV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubesubjectaccessreviewv1beta1props"></a>
...
## struct KubeTokenReviewProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubetokenreviewprops"></a>
...
## struct KubeTokenReviewV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubetokenreviewv1beta1props"></a>
...
## struct KubeValidatingWebhookConfigurationListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevalidatingwebhookconfigurationlistv1beta1props"></a>
...
## struct KubeValidatingWebhookConfigurationV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevalidatingwebhookconfigurationv1beta1props"></a>
...
-----|------|-------------
**metadata**?🔹 | <code>[k8s.ObjectMeta](#opencdk8s-cdk8s-argo-rollout-k8s-objectmeta)</code> | Standard object metadata;<br/>__*Optional*__
**webhooks**?🔹 | <code>Array<[k8s.ValidatingWebhook](#opencdk8s-cdk8s-argo-rollout-k8s-validatingwebhook)></code> | Webhooks is a list of webhooks and the affected resources and operations.<br/>__*Optional*__



## struct KubeVolumeAttachmentListProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentlistprops"></a>
...
## struct KubeVolumeAttachmentListV1Alpha1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentlistv1alpha1props"></a>
...
## struct KubeVolumeAttachmentListV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentlistv1beta1props"></a>
...
## struct KubeVolumeAttachmentProps 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentprops"></a>
...
## struct KubeVolumeAttachmentV1Alpha1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentv1alpha1props"></a>
...
## struct KubeVolumeAttachmentV1Beta1Props 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-kubevolumeattachmentv1beta1props"></a>
...
## struct LabelSelector 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-labelselector"></a>
...
Name | Type | Description 
-----|------|-------------
**matchExpressions**?🔹 | <code>Array<[k8s.LabelSelectorRequirement](#opencdk8s-cdk8s-argo-rollout-k8s-labelselectorrequirement)></code> | matchExpressions is a list of label selector requirements.<br/>__*Optional*__
**matchLabels**?🔹 | <code>Map<string, string></code> | matchLabels is a map of {key,value} pairs.<br/>__*Optional*__



## struct LabelSelectorRequirement 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-labelselectorrequirement"></a>
...
## struct LeaseSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-leasespec"></a>
...
## struct Lifecycle 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-lifecycle"></a>
...
Name | Type | Description 
-----|------|-------------
**postStart**?🔹 | <code>[k8s.Handler](#opencdk8s-cdk8s-argo-rollout-k8s-handler)</code> | PostStart is called immediately after a container is created.<br/>__*Optional*__
**preStop**?🔹 | <code>[k8s.Handler](#opencdk8s-cdk8s-argo-rollout-k8s-handler)</code> | PreStop is called immediately before a container is terminated due to an API request or management event such as liveness probe failure, preemption, resource contention, etc.<br/>__*Optional*__



## struct LimitRangeItem 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-limitrangeitem"></a>
...
Name | Type | Description 
-----|------|-------------
**default**?🔹 | <code>Map<string, [k8s.Quantity](#opencdk8s-cdk8s-argo-rollout-k8s-quantity)></code> | Default resource requirement limit value by resource name if resource limit is omitted.<br/>__*Optional*__
**defaultRequest**?🔹 | <code>Map<string, [k8s.Quantity](#opencdk8s-cdk8s-argo-rollout-k8s-quantity)></code> | DefaultRequest is the default resource requirement request value by resource name if resource request is omitted.<br/>__*Optional*__
**max**?🔹 | <code>Map<string, [k8s.Quantity](#opencdk8s-cdk8s-argo-rollout-k8s-quantity)></code> | Max usage constraints on this kind by resource name.<br/>__*Optional*__
**maxLimitRequestRatio**?🔹 | <code>Map<string, [k8s.Quantity](#opencdk8s-cdk8s-argo-rollout-k8s-quantity)></code> | MaxLimitRequestRatio if specified, the named resource must have a request and limit that are both non-zero where limit divided by request is less than or equal to the enumerated value;<br/>__*Optional*__
**min**?🔹 | <code>Map<string, [k8s.Quantity](#opencdk8s-cdk8s-argo-rollout-k8s-quantity)></code> | Min usage constraints on this kind by resource name.<br/>__*Optional*__
**type**?🔹 | <code>string</code> | Type of resource that this limit applies to.<br/>__*Optional*__



## struct LimitRangeSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-limitrangespec"></a>
...
Name | Type | Description 
-----|------|-------------
**limits**🔹 | <code>Array<[k8s.LimitRangeItem](#opencdk8s-cdk8s-argo-rollout-k8s-limitrangeitem)></code> | Limits is the list of LimitRangeItem objects that are enforced.



## struct ListMeta 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-listmeta"></a>
...
## struct LocalObjectReference 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-localobjectreference"></a>
...
## struct LocalVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-localvolumesource"></a>
...
## struct ManagedFieldsEntry 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-managedfieldsentry"></a>
...
## struct MetricIdentifier 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-metricidentifier"></a>
...
**selector**?🔹 | <code>[k8s.LabelSelector](#opencdk8s-cdk8s-argo-rollout-k8s-labelselector)</code> | selector is the string-encoded form of a standard kubernetes label selector for the given metric When set, it is passed as an additional parameter to the metrics server for more specific metrics scoping.<br/>__*Optional*__



## struct MetricSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-metricspec"></a>
...
**external**?🔹 | <code>[k8s.ExternalMetricSource](#opencdk8s-cdk8s-argo-rollout-k8s-externalmetricsource)</code> | external refers to a global metric that is not associated with any Kubernetes object.<br/>__*Optional*__
**object**?🔹 | <code>[k8s.ObjectMetricSource](#opencdk8s-cdk8s-argo-rollout-k8s-objectmetricsource)</code> | object refers to a metric describing a single kubernetes object (for example, hits-per-second on an Ingress object).<br/>__*Optional*__
**pods**?🔹 | <code>[k8s.PodsMetricSource](#opencdk8s-cdk8s-argo-rollout-k8s-podsmetricsource)</code> | pods refers to a metric describing each pod in the current scale target (for example, transactions-processed-per-second).<br/>__*Optional*__
**resource**?🔹 | <code>[k8s.ResourceMetricSource](#opencdk8s-cdk8s-argo-rollout-k8s-resourcemetricsource)</code> | resource refers to a resource metric (such as those specified in requests and limits) known to Kubernetes describing each pod in the current scale target (e.g. CPU or memory). Such metrics are built in to Kubernetes, and have special scaling options on top of those available to normal per-pod metrics using the "pods" source.<br/>__*Optional*__



## struct MetricTarget 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-metrictarget"></a>
...
**averageValue**?🔹 | <code>[k8s.Quantity](#opencdk8s-cdk8s-argo-rollout-k8s-quantity)</code> | averageValue is the target value of the average of the metric across all relevant pods (as a quantity).<br/>__*Optional*__
**value**?🔹 | <code>[k8s.Quantity](#opencdk8s-cdk8s-argo-rollout-k8s-quantity)</code> | value is the target value of the metric (as a quantity).<br/>__*Optional*__



## struct MutatingWebhook 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-mutatingwebhook"></a>
...
Name | Type | Description 
-----|------|-------------
**clientConfig**🔹 | <code>[k8s.WebhookClientConfig](#opencdk8s-cdk8s-argo-rollout-k8s-webhookclientconfig)</code> | ClientConfig defines how to communicate with the hook.
...
**namespaceSelector**?🔹 | <code>[k8s.LabelSelector](#opencdk8s-cdk8s-argo-rollout-k8s-labelselector)</code> | NamespaceSelector decides whether to run the webhook on an object based on whether the namespace for that object matches the selector.<br/>__*Default*__: the empty LabelSelector, which matches everything.
**objectSelector**?🔹 | <code>[k8s.LabelSelector](#opencdk8s-cdk8s-argo-rollout-k8s-labelselector)</code> | ObjectSelector decides whether to run the webhook based on if the object has matching labels.<br/>__*Default*__: the empty LabelSelector, which matches everything.
...
**rules**?🔹 | <code>Array<[k8s.RuleWithOperations](#opencdk8s-cdk8s-argo-rollout-k8s-rulewithoperations)></code> | Rules describes what operations on what resources/subresources the webhook cares about.<br/>__*Optional*__
...
## struct NamespaceSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-namespacespec"></a>
...
## struct NetworkPolicyEgressRule 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-networkpolicyegressrule"></a>
...
Name | Type | Description 
-----|------|-------------
**ports**?🔹 | <code>Array<[k8s.NetworkPolicyPort](#opencdk8s-cdk8s-argo-rollout-k8s-networkpolicyport)></code> | List of destination ports for outgoing traffic.<br/>__*Optional*__
**to**?🔹 | <code>Array<[k8s.NetworkPolicyPeer](#opencdk8s-cdk8s-argo-rollout-k8s-networkpolicypeer)></code> | List of destinations for outgoing traffic of pods selected for this rule.<br/>__*Optional*__



## struct NetworkPolicyIngressRule 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-networkpolicyingressrule"></a>
...
Name | Type | Description 
-----|------|-------------
**from**?🔹 | <code>Array<[k8s.NetworkPolicyPeer](#opencdk8s-cdk8s-argo-rollout-k8s-networkpolicypeer)></code> | List of sources which should be able to access the pods selected for this rule.<br/>__*Optional*__
**ports**?🔹 | <code>Array<[k8s.NetworkPolicyPort](#opencdk8s-cdk8s-argo-rollout-k8s-networkpolicyport)></code> | List of ports which should be made accessible on the pods selected for this rule.<br/>__*Optional*__



## struct NetworkPolicyPeer 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-networkpolicypeer"></a>
...
Name | Type | Description 
-----|------|-------------
**ipBlock**?🔹 | <code>[k8s.IpBlock](#opencdk8s-cdk8s-argo-rollout-k8s-ipblock)</code> | IPBlock defines policy on a particular IPBlock.<br/>__*Optional*__
**namespaceSelector**?🔹 | <code>[k8s.LabelSelector](#opencdk8s-cdk8s-argo-rollout-k8s-labelselector)</code> | Selects Namespaces using cluster-scoped labels.<br/>__*Optional*__
**podSelector**?🔹 | <code>[k8s.LabelSelector](#opencdk8s-cdk8s-argo-rollout-k8s-labelselector)</code> | This is a label selector which selects Pods.<br/>__*Optional*__



## struct NetworkPolicyPort 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-networkpolicyport"></a>
...
Name | Type | Description 
-----|------|-------------
**port**?🔹 | <code>[k8s.IntOrString](#opencdk8s-cdk8s-argo-rollout-k8s-intorstring)</code> | The port on the given protocol.<br/>__*Optional*__
**protocol**?🔹 | <code>string</code> | The protocol (TCP, UDP, or SCTP) which traffic must match.<br/>__*Optional*__



## struct NetworkPolicySpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-networkpolicyspec"></a>
...
Name | Type | Description 
-----|------|-------------
**podSelector**🔹 | <code>[k8s.LabelSelector](#opencdk8s-cdk8s-argo-rollout-k8s-labelselector)</code> | Selects the pods to which this NetworkPolicy object applies.
**egress**?🔹 | <code>Array<[k8s.NetworkPolicyEgressRule](#opencdk8s-cdk8s-argo-rollout-k8s-networkpolicyegressrule)></code> | List of egress rules to be applied to the selected pods.<br/>__*Optional*__
**ingress**?🔹 | <code>Array<[k8s.NetworkPolicyIngressRule](#opencdk8s-cdk8s-argo-rollout-k8s-networkpolicyingressrule)></code> | List of ingress rules to be applied to the selected pods.<br/>__*Optional*__
**policyTypes**?🔹 | <code>Array<string></code> | List of rule types that the NetworkPolicy relates to.<br/>__*Optional*__



## struct NfsVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-nfsvolumesource"></a>
...
## struct NodeAffinity 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-nodeaffinity"></a>
...
Name | Type | Description 
-----|------|-------------
**preferredDuringSchedulingIgnoredDuringExecution**?🔹 | <code>Array<[k8s.PreferredSchedulingTerm](#opencdk8s-cdk8s-argo-rollout-k8s-preferredschedulingterm)></code> | The scheduler will prefer to schedule pods to nodes that satisfy the affinity expressions specified by this field, but it may choose a node that violates one or more of the expressions.<br/>__*Optional*__
**requiredDuringSchedulingIgnoredDuringExecution**?🔹 | <code>[k8s.NodeSelector](#opencdk8s-cdk8s-argo-rollout-k8s-nodeselector)</code> | If the affinity requirements specified by this field are not met at scheduling time, the pod will not be scheduled onto the node.<br/>__*Optional*__



## struct NodeConfigSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-nodeconfigsource"></a>
...
Name | Type | Description 
-----|------|-------------
**configMap**?🔹 | <code>[k8s.ConfigMapNodeConfigSource](#opencdk8s-cdk8s-argo-rollout-k8s-configmapnodeconfigsource)</code> | ConfigMap is a reference to a Node's ConfigMap.<br/>__*Optional*__



## struct NodeSelector 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-nodeselector"></a>
...
Name | Type | Description 
-----|------|-------------
**nodeSelectorTerms**🔹 | <code>Array<[k8s.NodeSelectorTerm](#opencdk8s-cdk8s-argo-rollout-k8s-nodeselectorterm)></code> | Required.



## struct NodeSelectorRequirement 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-nodeselectorrequirement"></a>
...
## struct NodeSelectorTerm 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-nodeselectorterm"></a>
...
Name | Type | Description 
-----|------|-------------
**matchExpressions**?🔹 | <code>Array<[k8s.NodeSelectorRequirement](#opencdk8s-cdk8s-argo-rollout-k8s-nodeselectorrequirement)></code> | A list of node selector requirements by node's labels.<br/>__*Optional*__
**matchFields**?🔹 | <code>Array<[k8s.NodeSelectorRequirement](#opencdk8s-cdk8s-argo-rollout-k8s-nodeselectorrequirement)></code> | A list of node selector requirements by node's fields.<br/>__*Optional*__



## struct NodeSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-nodespec"></a>
...
Name | Type | Description 
-----|------|-------------
**configSource**?🔹 | <code>[k8s.NodeConfigSource](#opencdk8s-cdk8s-argo-rollout-k8s-nodeconfigsource)</code> | If specified, the source to get node configuration from The DynamicKubeletConfig feature gate must be enabled for the Kubelet to use this field.<br/>__*Optional*__
...
**taints**?🔹 | <code>Array<[k8s.Taint](#opencdk8s-cdk8s-argo-rollout-k8s-taint)></code> | If specified, the node's taints.<br/>__*Optional*__
**unschedulable**?🔹 | <code>boolean</code> | Unschedulable controls node schedulability of new pods.<br/>__*Optional*__



## struct NonResourceAttributes 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-nonresourceattributes"></a>
...
## struct ObjectFieldSelector 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-objectfieldselector"></a>
...
## struct ObjectMeta 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-objectmeta"></a>
...
**initializers**?🔹 | <code>[k8s.Initializers](#opencdk8s-cdk8s-argo-rollout-k8s-initializers)</code> | An initializer is a controller which enforces some system invariant at object creation time.<br/>__*Optional*__
...
**managedFields**?🔹 | <code>Array<[k8s.ManagedFieldsEntry](#opencdk8s-cdk8s-argo-rollout-k8s-managedfieldsentry)></code> | ManagedFields maps workflow-id and version to the set of fields that are managed by that workflow.<br/>__*Optional*__
...
**ownerReferences**?🔹 | <code>Array<[k8s.OwnerReference](#opencdk8s-cdk8s-argo-rollout-k8s-ownerreference)></code> | List of objects depended by this object.<br/>__*Optional*__
...
## struct ObjectMetricSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-objectmetricsource"></a>
...
Name | Type | Description 
-----|------|-------------
**describedObject**🔹 | <code>[k8s.CrossVersionObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-crossversionobjectreference)</code> | <span></span>
**metric**🔹 | <code>[k8s.MetricIdentifier](#opencdk8s-cdk8s-argo-rollout-k8s-metricidentifier)</code> | metric identifies the target metric by name and selector.
**target**🔹 | <code>[k8s.MetricTarget](#opencdk8s-cdk8s-argo-rollout-k8s-metrictarget)</code> | target specifies the target value for the given metric.



## struct ObjectReference 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-objectreference"></a>
...
## struct OwnerReference 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-ownerreference"></a>
...
## struct PersistentVolumeClaimSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-persistentvolumeclaimspec"></a>
...
**dataSource**?🔹 | <code>[k8s.TypedLocalObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-typedlocalobjectreference)</code> | This field requires the VolumeSnapshotDataSource alpha feature gate to be enabled and currently VolumeSnapshot is the only supported data source.<br/>__*Optional*__
**resources**?🔹 | <code>[k8s.ResourceRequirements](#opencdk8s-cdk8s-argo-rollout-k8s-resourcerequirements)</code> | Resources represents the minimum resources the volume should have.<br/>__*Optional*__
**selector**?🔹 | <code>[k8s.LabelSelector](#opencdk8s-cdk8s-argo-rollout-k8s-labelselector)</code> | A label query over volumes to consider for binding.<br/>__*Optional*__
...
## struct PersistentVolumeClaimVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-persistentvolumeclaimvolumesource"></a>
...
## struct PersistentVolumeSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-persistentvolumespec"></a>
...
**awsElasticBlockStore**?🔹 | <code>[k8s.AwsElasticBlockStoreVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-awselasticblockstorevolumesource)</code> | AWSElasticBlockStore represents an AWS Disk resource that is attached to a kubelet's host machine and then exposed to the pod.<br/>__*Optional*__
**azureDisk**?🔹 | <code>[k8s.AzureDiskVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-azurediskvolumesource)</code> | AzureDisk represents an Azure Data Disk mount on the host and bind mount to the pod.<br/>__*Optional*__
**azureFile**?🔹 | <code>[k8s.AzureFilePersistentVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-azurefilepersistentvolumesource)</code> | AzureFile represents an Azure File Service mount on the host and bind mount to the pod.<br/>__*Optional*__
**capacity**?🔹 | <code>Map<string, [k8s.Quantity](#opencdk8s-cdk8s-argo-rollout-k8s-quantity)></code> | A description of the persistent volume's resources and capacity.<br/>__*Optional*__
**cephfs**?🔹 | <code>[k8s.CephFsPersistentVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-cephfspersistentvolumesource)</code> | CephFS represents a Ceph FS mount on the host that shares a pod's lifetime.<br/>__*Optional*__
**cinder**?🔹 | <code>[k8s.CinderPersistentVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-cinderpersistentvolumesource)</code> | Cinder represents a cinder volume attached and mounted on kubelets host machine More info: https://releases.k8s.io/HEAD/examples/mysql-cinder-pd/README.md.<br/>__*Optional*__
**claimRef**?🔹 | <code>[k8s.ObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-objectreference)</code> | ClaimRef is part of a bi-directional binding between PersistentVolume and PersistentVolumeClaim.<br/>__*Optional*__
**csi**?🔹 | <code>[k8s.CsiPersistentVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-csipersistentvolumesource)</code> | CSI represents storage that is handled by an external CSI driver (Beta feature).<br/>__*Optional*__
**fc**?🔹 | <code>[k8s.FcVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-fcvolumesource)</code> | FC represents a Fibre Channel resource that is attached to a kubelet's host machine and then exposed to the pod.<br/>__*Optional*__
**flexVolume**?🔹 | <code>[k8s.FlexPersistentVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-flexpersistentvolumesource)</code> | FlexVolume represents a generic volume resource that is provisioned/attached using an exec based plugin.<br/>__*Optional*__
**flocker**?🔹 | <code>[k8s.FlockerVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-flockervolumesource)</code> | Flocker represents a Flocker volume attached to a kubelet's host machine and exposed to the pod for its usage.<br/>__*Optional*__
**gcePersistentDisk**?🔹 | <code>[k8s.GcePersistentDiskVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-gcepersistentdiskvolumesource)</code> | GCEPersistentDisk represents a GCE Disk resource that is attached to a kubelet's host machine and then exposed to the pod.<br/>__*Optional*__
**glusterfs**?🔹 | <code>[k8s.GlusterfsPersistentVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-glusterfspersistentvolumesource)</code> | Glusterfs represents a Glusterfs volume that is attached to a host and exposed to the pod.<br/>__*Optional*__
**hostPath**?🔹 | <code>[k8s.HostPathVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-hostpathvolumesource)</code> | HostPath represents a directory on the host.<br/>__*Optional*__
**iscsi**?🔹 | <code>[k8s.IscsiPersistentVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-iscsipersistentvolumesource)</code> | ISCSI represents an ISCSI Disk resource that is attached to a kubelet's host machine and then exposed to the pod.<br/>__*Optional*__
**local**?🔹 | <code>[k8s.LocalVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-localvolumesource)</code> | Local represents directly-attached storage with node affinity.<br/>__*Optional*__
...
**nfs**?🔹 | <code>[k8s.NfsVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-nfsvolumesource)</code> | NFS represents an NFS mount on the host.<br/>__*Optional*__
**nodeAffinity**?🔹 | <code>[k8s.VolumeNodeAffinity](#opencdk8s-cdk8s-argo-rollout-k8s-volumenodeaffinity)</code> | NodeAffinity defines constraints that limit what nodes this volume can be accessed from.<br/>__*Optional*__
...
**photonPersistentDisk**?🔹 | <code>[k8s.PhotonPersistentDiskVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-photonpersistentdiskvolumesource)</code> | PhotonPersistentDisk represents a PhotonController persistent disk attached and mounted on kubelets host machine.<br/>__*Optional*__
**portworxVolume**?🔹 | <code>[k8s.PortworxVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-portworxvolumesource)</code> | PortworxVolume represents a portworx volume attached and mounted on kubelets host machine.<br/>__*Optional*__
**quobyte**?🔹 | <code>[k8s.QuobyteVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-quobytevolumesource)</code> | Quobyte represents a Quobyte mount on the host that shares a pod's lifetime.<br/>__*Optional*__
**rbd**?🔹 | <code>[k8s.RbdPersistentVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-rbdpersistentvolumesource)</code> | RBD represents a Rados Block Device mount on the host that shares a pod's lifetime.<br/>__*Optional*__
**scaleIO**?🔹 | <code>[k8s.ScaleIoPersistentVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-scaleiopersistentvolumesource)</code> | ScaleIO represents a ScaleIO persistent volume attached and mounted on Kubernetes nodes.<br/>__*Optional*__
...
**vsphereVolume**?🔹 | <code>[k8s.VsphereVirtualDiskVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-vspherevirtualdiskvolumesource)</code> | VsphereVolume represents a vSphere volume attached and mounted on kubelets host machine.<br/>__*Optional*__



## struct PhotonPersistentDiskVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-photonpersistentdiskvolumesource"></a>
...
## struct PodAffinity 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-podaffinity"></a>
...
Name | Type | Description 
-----|------|-------------
**preferredDuringSchedulingIgnoredDuringExecution**?🔹 | <code>Array<[k8s.WeightedPodAffinityTerm](#opencdk8s-cdk8s-argo-rollout-k8s-weightedpodaffinityterm)></code> | The scheduler will prefer to schedule pods to nodes that satisfy the affinity expressions specified by this field, but it may choose a node that violates one or more of the expressions.<br/>__*Optional*__
**requiredDuringSchedulingIgnoredDuringExecution**?🔹 | <code>Array<[k8s.PodAffinityTerm](#opencdk8s-cdk8s-argo-rollout-k8s-podaffinityterm)></code> | If the affinity requirements specified by this field are not met at scheduling time, the pod will not be scheduled onto the node.<br/>__*Optional*__



## struct PodAffinityTerm 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-podaffinityterm"></a>
...
**labelSelector**?🔹 | <code>[k8s.LabelSelector](#opencdk8s-cdk8s-argo-rollout-k8s-labelselector)</code> | A label query over a set of resources, in this case pods.<br/>__*Optional*__
...
## struct PodAntiAffinity 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-podantiaffinity"></a>
...
Name | Type | Description 
-----|------|-------------
**preferredDuringSchedulingIgnoredDuringExecution**?🔹 | <code>Array<[k8s.WeightedPodAffinityTerm](#opencdk8s-cdk8s-argo-rollout-k8s-weightedpodaffinityterm)></code> | The scheduler will prefer to schedule pods to nodes that satisfy the anti-affinity expressions specified by this field, but it may choose a node that violates one or more of the expressions.<br/>__*Optional*__
**requiredDuringSchedulingIgnoredDuringExecution**?🔹 | <code>Array<[k8s.PodAffinityTerm](#opencdk8s-cdk8s-argo-rollout-k8s-podaffinityterm)></code> | If the anti-affinity requirements specified by this field are not met at scheduling time, the pod will not be scheduled onto the node.<br/>__*Optional*__



## struct PodDisruptionBudgetSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-poddisruptionbudgetspec"></a>
...
**options**?🔹 | <code>Array<[k8s.PodDnsConfigOption](#opencdk8s-cdk8s-argo-rollout-k8s-poddnsconfigoption)></code> | A list of DNS resolver options.<br/>__*Optional*__
**searches**?🔹 | <code>Array<string></code> | A list of DNS search domains for host-name lookup.<br/>__*Optional*__



## struct PodDnsConfigOption 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-poddnsconfigoption"></a>
...
## struct PodPresetSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-podpresetspec"></a>
...
Name | Type | Description 
-----|------|-------------
**env**?🔹 | <code>Array<[k8s.EnvVar](#opencdk8s-cdk8s-argo-rollout-k8s-envvar)></code> | Env defines the collection of EnvVar to inject into containers.<br/>__*Optional*__
**envFrom**?🔹 | <code>Array<[k8s.EnvFromSource](#opencdk8s-cdk8s-argo-rollout-k8s-envfromsource)></code> | EnvFrom defines the collection of EnvFromSource to inject into containers.<br/>__*Optional*__
**selector**?🔹 | <code>[k8s.LabelSelector](#opencdk8s-cdk8s-argo-rollout-k8s-labelselector)</code> | Selector is a label query over a set of resources, in this case pods.<br/>__*Optional*__
**volumeMounts**?🔹 | <code>Array<[k8s.VolumeMount](#opencdk8s-cdk8s-argo-rollout-k8s-volumemount)></code> | VolumeMounts defines the collection of VolumeMount to inject into containers.<br/>__*Optional*__
**volumes**?🔹 | <code>Array<[k8s.Volume](#opencdk8s-cdk8s-argo-rollout-k8s-volume)></code> | Volumes defines the collection of Volume to inject into the pod.<br/>__*Optional*__



## struct PodReadinessGate 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-podreadinessgate"></a>
...
## struct PodSecurityContext 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-podsecuritycontext"></a>
...
**seLinuxOptions**?🔹 | <code>[k8s.SeLinuxOptions](#opencdk8s-cdk8s-argo-rollout-k8s-selinuxoptions)</code> | The SELinux context to be applied to all containers.<br/>__*Optional*__
...
**sysctls**?🔹 | <code>Array<[k8s.Sysctl](#opencdk8s-cdk8s-argo-rollout-k8s-sysctl)></code> | Sysctls hold a list of namespaced sysctls used for the pod.<br/>__*Optional*__
**windowsOptions**?🔹 | <code>[k8s.WindowsSecurityContextOptions](#opencdk8s-cdk8s-argo-rollout-k8s-windowssecuritycontextoptions)</code> | Windows security options.<br/>__*Optional*__



## struct PodSecurityPolicySpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-podsecuritypolicyspec"></a>
...
Name | Type | Description 
-----|------|-------------
**fsGroup**🔹 | <code>[k8s.FsGroupStrategyOptions](#opencdk8s-cdk8s-argo-rollout-k8s-fsgroupstrategyoptions)</code> | fsGroup is the strategy that will dictate what fs group is used by the SecurityContext.
**runAsUser**🔹 | <code>[k8s.RunAsUserStrategyOptions](#opencdk8s-cdk8s-argo-rollout-k8s-runasuserstrategyoptions)</code> | runAsUser is the strategy that will dictate the allowable RunAsUser values that may be set.
**seLinux**🔹 | <code>[k8s.SeLinuxStrategyOptions](#opencdk8s-cdk8s-argo-rollout-k8s-selinuxstrategyoptions)</code> | seLinux is the strategy that will dictate the allowable labels that may be set.
**supplementalGroups**🔹 | <code>[k8s.SupplementalGroupsStrategyOptions](#opencdk8s-cdk8s-argo-rollout-k8s-supplementalgroupsstrategyoptions)</code> | supplementalGroups is the strategy that will dictate what supplemental groups are used by the SecurityContext.
...
**allowedCSIDrivers**?🔹 | <code>Array<[k8s.AllowedCsiDriver](#opencdk8s-cdk8s-argo-rollout-k8s-allowedcsidriver)></code> | AllowedCSIDrivers is a whitelist of inline CSI drivers that must be explicitly set to be embedded within a pod spec.<br/>__*Optional*__
...
**allowedFlexVolumes**?🔹 | <code>Array<[k8s.AllowedFlexVolume](#opencdk8s-cdk8s-argo-rollout-k8s-allowedflexvolume)></code> | allowedFlexVolumes is a whitelist of allowed Flexvolumes.<br/>__*Optional*__
**allowedHostPaths**?🔹 | <code>Array<[k8s.AllowedHostPath](#opencdk8s-cdk8s-argo-rollout-k8s-allowedhostpath)></code> | allowedHostPaths is a white list of allowed host paths.<br/>__*Optional*__
...
**hostPorts**?🔹 | <code>Array<[k8s.HostPortRange](#opencdk8s-cdk8s-argo-rollout-k8s-hostportrange)></code> | hostPorts determines which host port ranges are allowed to be exposed.<br/>__*Optional*__
...
**runAsGroup**?🔹 | <code>[k8s.RunAsGroupStrategyOptions](#opencdk8s-cdk8s-argo-rollout-k8s-runasgroupstrategyoptions)</code> | RunAsGroup is the strategy that will dictate the allowable RunAsGroup values that may be set.<br/>__*Optional*__
**runtimeClass**?🔹 | <code>[k8s.RuntimeClassStrategyOptions](#opencdk8s-cdk8s-argo-rollout-k8s-runtimeclassstrategyoptions)</code> | runtimeClass is the strategy that will dictate the allowable RuntimeClasses for a pod.<br/>__*Optional*__
**volumes**?🔹 | <code>Array<string></code> | volumes is a white list of allowed volume plugins.<br/>__*Optional*__



## struct PodSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-podspec"></a>
...
Name | Type | Description 
-----|------|-------------
**containers**🔹 | <code>Array<[k8s.Container](#opencdk8s-cdk8s-argo-rollout-k8s-container)></code> | List of containers belonging to the pod.
...
**affinity**?🔹 | <code>[k8s.Affinity](#opencdk8s-cdk8s-argo-rollout-k8s-affinity)</code> | If specified, the pod's scheduling constraints.<br/>__*Optional*__
...
**dnsConfig**?🔹 | <code>[k8s.PodDnsConfig](#opencdk8s-cdk8s-argo-rollout-k8s-poddnsconfig)</code> | Specifies the DNS parameters of a pod.<br/>__*Optional*__
...
**hostAliases**?🔹 | <code>Array<[k8s.HostAlias](#opencdk8s-cdk8s-argo-rollout-k8s-hostalias)></code> | HostAliases is an optional list of hosts and IPs that will be injected into the pod's hosts file if specified.<br/>__*Optional*__
...
**imagePullSecrets**?🔹 | <code>Array<[k8s.LocalObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-localobjectreference)></code> | ImagePullSecrets is an optional list of references to secrets in the same namespace to use for pulling any of the images used by this PodSpec.<br/>__*Optional*__
**initContainers**?🔹 | <code>Array<[k8s.Container](#opencdk8s-cdk8s-argo-rollout-k8s-container)></code> | List of initialization containers belonging to the pod.<br/>__*Optional*__
...
**readinessGates**?🔹 | <code>Array<[k8s.PodReadinessGate](#opencdk8s-cdk8s-argo-rollout-k8s-podreadinessgate)></code> | If specified, all readiness gates will be evaluated for pod readiness.<br/>__*Optional*__
...
**securityContext**?🔹 | <code>[k8s.PodSecurityContext](#opencdk8s-cdk8s-argo-rollout-k8s-podsecuritycontext)</code> | SecurityContext holds pod-level security attributes and common container settings.<br/>__*Default*__: empty.  See type description for default values of each field.
...
**tolerations**?🔹 | <code>Array<[k8s.Toleration](#opencdk8s-cdk8s-argo-rollout-k8s-toleration)></code> | If specified, the pod's tolerations.<br/>__*Optional*__
**volumes**?🔹 | <code>Array<[k8s.Volume](#opencdk8s-cdk8s-argo-rollout-k8s-volume)></code> | List of volumes that can be mounted by containers belonging to the pod.<br/>__*Optional*__



## struct PodTemplateSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-podtemplatespec"></a>
...
## struct PodsMetricSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-podsmetricsource"></a>
...
## struct Policy 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-policy"></a>
...
## struct PolicyRule 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-policyrule"></a>
...
## struct PortworxVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-portworxvolumesource"></a>
...
## struct Preconditions 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-preconditions"></a>
...
## struct PreferredSchedulingTerm 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-preferredschedulingterm"></a>
...
Name | Type | Description 
-----|------|-------------
**preference**🔹 | <code>[k8s.NodeSelectorTerm](#opencdk8s-cdk8s-argo-rollout-k8s-nodeselectorterm)</code> | A node selector term, associated with the corresponding weight.
**weight**🔹 | <code>number</code> | Weight associated with matching the corresponding nodeSelectorTerm, in the range 1-100.



## struct Probe 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-probe"></a>
...
## struct ProjectedVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-projectedvolumesource"></a>
...
Name | Type | Description 
-----|------|-------------
**sources**🔹 | <code>Array<[k8s.VolumeProjection](#opencdk8s-cdk8s-argo-rollout-k8s-volumeprojection)></code> | list of volume projections.
**defaultMode**?🔹 | <code>number</code> | Mode bits to use on created files by default.<br/>__*Optional*__



## struct QuobyteVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-quobytevolumesource"></a>
...
## struct RawExtension 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-rawextension"></a>
...
## struct RbdPersistentVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-rbdpersistentvolumesource"></a>
...
**secretRef**?🔹 | <code>[k8s.SecretReference](#opencdk8s-cdk8s-argo-rollout-k8s-secretreference)</code> | SecretRef is name of the authentication secret for RBDUser.<br/>__*Default*__: nil. More info: https://releases.k8s.io/HEAD/examples/volumes/rbd/README.md#how-to-use-it
...
## struct RbdVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-rbdvolumesource"></a>
...
**pool**?🔹 | <code>string</code> | The rados pool name.<br/>__*Default*__: rbd. More info: https://releases.k8s.io/HEAD/examples/volumes/rbd/README.md#how-to-use-it
**readOnly**?🔹 | <code>boolean</code> | ReadOnly here will force the ReadOnly setting in VolumeMounts.<br/>__*Default*__: false. More info: https://releases.k8s.io/HEAD/examples/volumes/rbd/README.md#how-to-use-it
**secretRef**?🔹 | <code>[k8s.LocalObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-localobjectreference)</code> | SecretRef is name of the authentication secret for RBDUser.<br/>__*Default*__: nil. More info: https://releases.k8s.io/HEAD/examples/volumes/rbd/README.md#how-to-use-it
**user**?🔹 | <code>string</code> | The rados user name.<br/>__*Default*__: admin. More info: https://releases.k8s.io/HEAD/examples/volumes/rbd/README.md#how-to-use-it



## struct ReplicaSetSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-replicasetspec"></a>
...
**selector**?🔹 | <code>[k8s.LabelSelector](#opencdk8s-cdk8s-argo-rollout-k8s-labelselector)</code> | Selector is a label query over pods that should match the replica count.<br/>__*Optional*__
**template**?🔹 | <code>[k8s.PodTemplateSpec](#opencdk8s-cdk8s-argo-rollout-k8s-podtemplatespec)</code> | Template is the object that describes the pod that will be created if insufficient replicas are detected.<br/>__*Optional*__



## struct ReplicationControllerSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-replicationcontrollerspec"></a>
...
## struct ResourceAttributes 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-resourceattributes"></a>
...
## struct ResourceFieldSelector 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-resourcefieldselector"></a>
...
**divisor**?🔹 | <code>[k8s.Quantity](#opencdk8s-cdk8s-argo-rollout-k8s-quantity)</code> | Specifies the output format of the exposed resources, defaults to "1".<br/>__*Optional*__



## struct ResourceMetricSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-resourcemetricsource"></a>
...
## struct ResourceQuotaSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-resourcequotaspec"></a>
...
Name | Type | Description 
-----|------|-------------
**hard**?🔹 | <code>Map<string, [k8s.Quantity](#opencdk8s-cdk8s-argo-rollout-k8s-quantity)></code> | hard is the set of desired hard limits for each named resource.<br/>__*Optional*__
**scopeSelector**?🔹 | <code>[k8s.ScopeSelector](#opencdk8s-cdk8s-argo-rollout-k8s-scopeselector)</code> | scopeSelector is also a collection of filters like scopes that must match each object tracked by a quota but expressed using ScopeSelectorOperator in combination with possible values.<br/>__*Optional*__
**scopes**?🔹 | <code>Array<string></code> | A collection of filters that must match each object tracked by a quota.<br/>__*Optional*__



## struct ResourceRequirements 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-resourcerequirements"></a>
...
Name | Type | Description 
-----|------|-------------
**limits**?🔹 | <code>Map<string, [k8s.Quantity](#opencdk8s-cdk8s-argo-rollout-k8s-quantity)></code> | Limits describes the maximum amount of compute resources allowed.<br/>__*Optional*__
**requests**?🔹 | <code>Map<string, [k8s.Quantity](#opencdk8s-cdk8s-argo-rollout-k8s-quantity)></code> | Requests describes the minimum amount of compute resources required.<br/>__*Optional*__



## struct RoleRef 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-roleref"></a>
...
## struct RollingUpdateDaemonSet 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-rollingupdatedaemonset"></a>
...
Name | Type | Description 
-----|------|-------------
**maxUnavailable**?🔹 | <code>[k8s.IntOrString](#opencdk8s-cdk8s-argo-rollout-k8s-intorstring)</code> | The maximum number of DaemonSet pods that can be unavailable during the update.<br/>__*Optional*__



## struct RollingUpdateDeployment 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-rollingupdatedeployment"></a>
...
Name | Type | Description 
-----|------|-------------
**maxSurge**?🔹 | <code>[k8s.IntOrString](#opencdk8s-cdk8s-argo-rollout-k8s-intorstring)</code> | The maximum number of pods that can be scheduled above the desired number of pods.<br/>__*Default*__: 25%. Example: when this is set to 30%, the new ReplicaSet can be scaled up immediately when the rolling update starts, such that the total number of old and new pods do not exceed 130% of desired pods. Once old pods have been killed, new ReplicaSet can be scaled up further, ensuring that total number of pods running at any time during the update is at most 130% of desired pods.
**maxUnavailable**?🔹 | <code>[k8s.IntOrString](#opencdk8s-cdk8s-argo-rollout-k8s-intorstring)</code> | The maximum number of pods that can be unavailable during the update.<br/>__*Default*__: 25%. Example: when this is set to 30%, the old ReplicaSet can be scaled down to 70% of desired pods immediately when the rolling update starts. Once new pods are ready, old ReplicaSet can be scaled down further, followed by scaling up the new ReplicaSet, ensuring that the total number of pods available at all times during the update is at least 70% of desired pods.



## struct RollingUpdateStatefulSetStrategy 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-rollingupdatestatefulsetstrategy"></a>
...
## struct RuleWithOperations 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-rulewithoperations"></a>
...
## struct RunAsGroupStrategyOptions 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-runasgroupstrategyoptions"></a>
...
**ranges**?🔹 | <code>Array<[k8s.IdRange](#opencdk8s-cdk8s-argo-rollout-k8s-idrange)></code> | ranges are the allowed ranges of gids that may be used.<br/>__*Optional*__



## struct RunAsUserStrategyOptions 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-runasuserstrategyoptions"></a>
...
**ranges**?🔹 | <code>Array<[k8s.IdRange](#opencdk8s-cdk8s-argo-rollout-k8s-idrange)></code> | ranges are the allowed ranges of uids that may be used.<br/>__*Optional*__



## struct RuntimeClassSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-runtimeclassspec"></a>
...
## struct RuntimeClassStrategyOptions 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-runtimeclassstrategyoptions"></a>
...
## struct ScaleIoPersistentVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-scaleiopersistentvolumesource"></a>
...
**secretRef**🔹 | <code>[k8s.SecretReference](#opencdk8s-cdk8s-argo-rollout-k8s-secretreference)</code> | SecretRef references to the secret for ScaleIO user and other sensitive information.
...
## struct ScaleIoVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-scaleiovolumesource"></a>
...
-----|------|-------------
**gateway**🔹 | <code>string</code> | The host address of the ScaleIO API Gateway.
**secretRef**🔹 | <code>[k8s.LocalObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-localobjectreference)</code> | SecretRef references to the secret for ScaleIO user and other sensitive information.
**system**🔹 | <code>string</code> | The name of the storage system as configured in ScaleIO.
**fsType**?🔹 | <code>string</code> | Filesystem type to mount.<br/>__*Default*__: xfs".
**protectionDomain**?🔹 | <code>string</code> | The name of the ScaleIO Protection Domain for the configured storage.<br/>__*Optional*__
**readOnly**?🔹 | <code>boolean</code> | Defaults to false (read/write).<br/>__*Default*__: false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts.
...
## struct ScaleSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-scalespec"></a>
...
## struct ScopeSelector 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-scopeselector"></a>
...
Name | Type | Description 
-----|------|-------------
**matchExpressions**?🔹 | <code>Array<[k8s.ScopedResourceSelectorRequirement](#opencdk8s-cdk8s-argo-rollout-k8s-scopedresourceselectorrequirement)></code> | A list of scope selector requirements by scope of the resources.<br/>__*Optional*__



## struct ScopedResourceSelectorRequirement 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-scopedresourceselectorrequirement"></a>
...
## struct SeLinuxOptions 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-selinuxoptions"></a>
...
## struct SeLinuxStrategyOptions 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-selinuxstrategyoptions"></a>
...
**seLinuxOptions**?🔹 | <code>[k8s.SeLinuxOptions](#opencdk8s-cdk8s-argo-rollout-k8s-selinuxoptions)</code> | seLinuxOptions required to run as;<br/>__*Optional*__



## struct SecretEnvSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-secretenvsource"></a>
...
## struct SecretKeySelector 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-secretkeyselector"></a>
...
## struct SecretProjection 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-secretprojection"></a>
...
Name | Type | Description 
-----|------|-------------
**items**?🔹 | <code>Array<[k8s.KeyToPath](#opencdk8s-cdk8s-argo-rollout-k8s-keytopath)></code> | If unspecified, each key-value pair in the Data field of the referenced Secret will be projected into the volume as a file whose name is the key and content is the value.<br/>__*Optional*__
**name**?🔹 | <code>string</code> | Name of the referent.<br/>__*Optional*__
**optional**?🔹 | <code>boolean</code> | Specify whether the Secret or its key must be defined.<br/>__*Optional*__



## struct SecretReference 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-secretreference"></a>
...
## struct SecretVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-secretvolumesource"></a>
...
## struct SecurityContext 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-securitycontext"></a>
...
**capabilities**?🔹 | <code>[k8s.Capabilities](#opencdk8s-cdk8s-argo-rollout-k8s-capabilities)</code> | The capabilities to add/drop when running containers.<br/>__*Default*__: the default set of capabilities granted by the container runtime.
...
**seLinuxOptions**?🔹 | <code>[k8s.SeLinuxOptions](#opencdk8s-cdk8s-argo-rollout-k8s-selinuxoptions)</code> | The SELinux context to be applied to the container.<br/>__*Optional*__
**windowsOptions**?🔹 | <code>[k8s.WindowsSecurityContextOptions](#opencdk8s-cdk8s-argo-rollout-k8s-windowssecuritycontextoptions)</code> | Windows security options.<br/>__*Optional*__



## struct SelfSubjectAccessReviewSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-selfsubjectaccessreviewspec"></a>
...
Name | Type | Description 
-----|------|-------------
**nonResourceAttributes**?🔹 | <code>[k8s.NonResourceAttributes](#opencdk8s-cdk8s-argo-rollout-k8s-nonresourceattributes)</code> | NonResourceAttributes describes information for a non-resource access request.<br/>__*Optional*__
**resourceAttributes**?🔹 | <code>[k8s.ResourceAttributes](#opencdk8s-cdk8s-argo-rollout-k8s-resourceattributes)</code> | ResourceAuthorizationAttributes describes information for a resource access request.<br/>__*Optional*__



## struct SelfSubjectRulesReviewSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-selfsubjectrulesreviewspec"></a>
...
## struct ServiceAccountTokenProjection 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-serviceaccounttokenprojection"></a>
...
## struct ServicePort 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-serviceport"></a>
...
**protocol**?🔹 | <code>string</code> | The IP protocol for this port.<br/>__*Default*__: TCP.
**targetPort**?🔹 | <code>[k8s.IntOrString](#opencdk8s-cdk8s-argo-rollout-k8s-intorstring)</code> | Number or name of the port to access on the pods targeted by the service.<br/>__*Optional*__



## struct ServiceReference 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-servicereference"></a>
...
## struct ServiceSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-servicespec"></a>
...
**ports**?🔹 | <code>Array<[k8s.ServicePort](#opencdk8s-cdk8s-argo-rollout-k8s-serviceport)></code> | The list of ports that are exposed by this service.<br/>__*Optional*__
...
**sessionAffinityConfig**?🔹 | <code>[k8s.SessionAffinityConfig](#opencdk8s-cdk8s-argo-rollout-k8s-sessionaffinityconfig)</code> | sessionAffinityConfig contains the configurations of session affinity.<br/>__*Optional*__
...
## struct SessionAffinityConfig 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-sessionaffinityconfig"></a>
...
Name | Type | Description 
-----|------|-------------
**clientIP**?🔹 | <code>[k8s.ClientIpConfig](#opencdk8s-cdk8s-argo-rollout-k8s-clientipconfig)</code> | clientIP contains the configurations of Client IP based session affinity.<br/>__*Optional*__



## struct StatefulSetSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-statefulsetspec"></a>
...
Name | Type | Description 
-----|------|-------------
**selector**🔹 | <code>[k8s.LabelSelector](#opencdk8s-cdk8s-argo-rollout-k8s-labelselector)</code> | selector is a label query over pods that should match the replica count.
**serviceName**🔹 | <code>string</code> | serviceName is the name of the service that governs this StatefulSet.
**template**🔹 | <code>[k8s.PodTemplateSpec](#opencdk8s-cdk8s-argo-rollout-k8s-podtemplatespec)</code> | template is the object that describes the pod that will be created if insufficient replicas are detected.
...
**updateStrategy**?🔹 | <code>[k8s.StatefulSetUpdateStrategy](#opencdk8s-cdk8s-argo-rollout-k8s-statefulsetupdatestrategy)</code> | updateStrategy indicates the StatefulSetUpdateStrategy that will be employed to update Pods in the StatefulSet when a revision is made to Template.<br/>__*Optional*__
**volumeClaimTemplates**?🔹 | <code>Array<[k8s.KubePersistentVolumeClaimProps](#opencdk8s-cdk8s-argo-rollout-k8s-kubepersistentvolumeclaimprops)></code> | volumeClaimTemplates is a list of claims that pods are allowed to reference.<br/>__*Optional*__



## struct StatefulSetUpdateStrategy 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-statefulsetupdatestrategy"></a>
...
Name | Type | Description 
-----|------|-------------
**rollingUpdate**?🔹 | <code>[k8s.RollingUpdateStatefulSetStrategy](#opencdk8s-cdk8s-argo-rollout-k8s-rollingupdatestatefulsetstrategy)</code> | RollingUpdate is used to communicate parameters when Type is RollingUpdateStatefulSetStrategyType.<br/>__*Optional*__
**type**?🔹 | <code>string</code> | Type indicates the type of the StatefulSetUpdateStrategy.<br/>__*Default*__: RollingUpdate.



## struct StatusCause 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-statuscause"></a>
...
## struct StatusDetails 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-statusdetails"></a>
...
Name | Type | Description 
-----|------|-------------
**causes**?🔹 | <code>Array<[k8s.StatusCause](#opencdk8s-cdk8s-argo-rollout-k8s-statuscause)></code> | The Causes array includes more details associated with the StatusReason failure.<br/>__*Optional*__
...
## struct StorageOsPersistentVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-storageospersistentvolumesource"></a>
...
**fsType**?🔹 | <code>string</code> | Filesystem type to mount.<br/>__*Optional*__
**readOnly**?🔹 | <code>boolean</code> | Defaults to false (read/write).<br/>__*Default*__: false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts.
**secretRef**?🔹 | <code>[k8s.ObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-objectreference)</code> | SecretRef specifies the secret to use for obtaining the StorageOS API credentials.<br/>__*Optional*__
...
## struct StorageOsVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-storageosvolumesource"></a>
...
**fsType**?🔹 | <code>string</code> | Filesystem type to mount.<br/>__*Optional*__
**readOnly**?🔹 | <code>boolean</code> | Defaults to false (read/write).<br/>__*Default*__: false (read/write). ReadOnly here will force the ReadOnly setting in VolumeMounts.
**secretRef**?🔹 | <code>[k8s.LocalObjectReference](#opencdk8s-cdk8s-argo-rollout-k8s-localobjectreference)</code> | SecretRef specifies the secret to use for obtaining the StorageOS API credentials.<br/>__*Optional*__
**volumeName**?🔹 | <code>string</code> | VolumeName is the human-readable name of the StorageOS volume.<br/>__*Optional*__
**volumeNamespace**?🔹 | <code>string</code> | VolumeNamespace specifies the scope of the volume within StorageOS.<br/>__*Optional*__



## struct Subject 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-subject"></a>
...
## struct SubjectAccessReviewSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-subjectaccessreviewspec"></a>
...
## struct SupplementalGroupsStrategyOptions 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-supplementalgroupsstrategyoptions"></a>
...
Name | Type | Description 
-----|------|-------------
**ranges**?🔹 | <code>Array<[k8s.IdRange](#opencdk8s-cdk8s-argo-rollout-k8s-idrange)></code> | ranges are the allowed ranges of supplemental groups.<br/>__*Optional*__
...
## struct Sysctl 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-sysctl"></a>
...
## struct Taint 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-taint"></a>
...
## struct TcpSocketAction 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-tcpsocketaction"></a>
...
Name | Type | Description 
-----|------|-------------
**port**🔹 | <code>[k8s.IntOrString](#opencdk8s-cdk8s-argo-rollout-k8s-intorstring)</code> | Number or name of the port to access on the container.
**host**?🔹 | <code>string</code> | Optional: Host name to connect to, defaults to the pod IP.<br/>__*Optional*__



## struct TokenReviewSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-tokenreviewspec"></a>
...
## struct Toleration 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-toleration"></a>
...
## struct TopologySelectorLabelRequirement 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-topologyselectorlabelrequirement"></a>
...
## struct TopologySelectorTerm 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-topologyselectorterm"></a>
...
Name | Type | Description 
-----|------|-------------
**matchLabelExpressions**?🔹 | <code>Array<[k8s.TopologySelectorLabelRequirement](#opencdk8s-cdk8s-argo-rollout-k8s-topologyselectorlabelrequirement)></code> | A list of topology selector requirements by labels.<br/>__*Optional*__



## struct TypedLocalObjectReference 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-typedlocalobjectreference"></a>
...
## struct ValidatingWebhook 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-validatingwebhook"></a>
...
## struct Volume 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-volume"></a>
...
**awsElasticBlockStore**?🔹 | <code>[k8s.AwsElasticBlockStoreVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-awselasticblockstorevolumesource)</code> | AWSElasticBlockStore represents an AWS Disk resource that is attached to a kubelet's host machine and then exposed to the pod.<br/>__*Optional*__
**azureDisk**?🔹 | <code>[k8s.AzureDiskVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-azurediskvolumesource)</code> | AzureDisk represents an Azure Data Disk mount on the host and bind mount to the pod.<br/>__*Optional*__
**azureFile**?🔹 | <code>[k8s.AzureFileVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-azurefilevolumesource)</code> | AzureFile represents an Azure File Service mount on the host and bind mount to the pod.<br/>__*Optional*__
**cephfs**?🔹 | <code>[k8s.CephFsVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-cephfsvolumesource)</code> | CephFS represents a Ceph FS mount on the host that shares a pod's lifetime.<br/>__*Optional*__
**cinder**?🔹 | <code>[k8s.CinderVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-cindervolumesource)</code> | Cinder represents a cinder volume attached and mounted on kubelets host machine More info: https://releases.k8s.io/HEAD/examples/mysql-cinder-pd/README.md.<br/>__*Optional*__
**configMap**?🔹 | <code>[k8s.ConfigMapVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-configmapvolumesource)</code> | ConfigMap represents a configMap that should populate this volume.<br/>__*Optional*__
**csi**?🔹 | <code>[k8s.CsiVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-csivolumesource)</code> | CSI (Container Storage Interface) represents storage that is handled by an external CSI driver (Alpha feature).<br/>__*Optional*__
**downwardAPI**?🔹 | <code>[k8s.DownwardApiVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-downwardapivolumesource)</code> | DownwardAPI represents downward API about the pod that should populate this volume.<br/>__*Optional*__
**emptyDir**?🔹 | <code>[k8s.EmptyDirVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-emptydirvolumesource)</code> | EmptyDir represents a temporary directory that shares a pod's lifetime.<br/>__*Optional*__
**fc**?🔹 | <code>[k8s.FcVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-fcvolumesource)</code> | FC represents a Fibre Channel resource that is attached to a kubelet's host machine and then exposed to the pod.<br/>__*Optional*__
**flexVolume**?🔹 | <code>[k8s.FlexVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-flexvolumesource)</code> | FlexVolume represents a generic volume resource that is provisioned/attached using an exec based plugin.<br/>__*Optional*__
**flocker**?🔹 | <code>[k8s.FlockerVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-flockervolumesource)</code> | Flocker represents a Flocker volume attached to a kubelet's host machine.<br/>__*Optional*__
**gcePersistentDisk**?🔹 | <code>[k8s.GcePersistentDiskVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-gcepersistentdiskvolumesource)</code> | GCEPersistentDisk represents a GCE Disk resource that is attached to a kubelet's host machine and then exposed to the pod.<br/>__*Optional*__
**gitRepo**?🔹 | <code>[k8s.GitRepoVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-gitrepovolumesource)</code> | GitRepo represents a git repository at a particular revision.<br/>__*Optional*__
**glusterfs**?🔹 | <code>[k8s.GlusterfsVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-glusterfsvolumesource)</code> | Glusterfs represents a Glusterfs mount on the host that shares a pod's lifetime.<br/>__*Optional*__
**hostPath**?🔹 | <code>[k8s.HostPathVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-hostpathvolumesource)</code> | HostPath represents a pre-existing file or directory on the host machine that is directly exposed to the container.<br/>__*Optional*__
**iscsi**?🔹 | <code>[k8s.IscsiVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-iscsivolumesource)</code> | ISCSI represents an ISCSI Disk resource that is attached to a kubelet's host machine and then exposed to the pod.<br/>__*Optional*__
**nfs**?🔹 | <code>[k8s.NfsVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-nfsvolumesource)</code> | NFS represents an NFS mount on the host that shares a pod's lifetime More info: https://kubernetes.io/docs/concepts/storage/volumes#nfs.<br/>__*Optional*__
**persistentVolumeClaim**?🔹 | <code>[k8s.PersistentVolumeClaimVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-persistentvolumeclaimvolumesource)</code> | PersistentVolumeClaimVolumeSource represents a reference to a PersistentVolumeClaim in the same namespace.<br/>__*Optional*__
**photonPersistentDisk**?🔹 | <code>[k8s.PhotonPersistentDiskVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-photonpersistentdiskvolumesource)</code> | PhotonPersistentDisk represents a PhotonController persistent disk attached and mounted on kubelets host machine.<br/>__*Optional*__
**portworxVolume**?🔹 | <code>[k8s.PortworxVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-portworxvolumesource)</code> | PortworxVolume represents a portworx volume attached and mounted on kubelets host machine.<br/>__*Optional*__
**projected**?🔹 | <code>[k8s.ProjectedVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-projectedvolumesource)</code> | Items for all in one resources secrets, configmaps, and downward API.<br/>__*Optional*__
**quobyte**?🔹 | <code>[k8s.QuobyteVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-quobytevolumesource)</code> | Quobyte represents a Quobyte mount on the host that shares a pod's lifetime.<br/>__*Optional*__
**rbd**?🔹 | <code>[k8s.RbdVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-rbdvolumesource)</code> | RBD represents a Rados Block Device mount on the host that shares a pod's lifetime.<br/>__*Optional*__
**scaleIO**?🔹 | <code>[k8s.ScaleIoVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-scaleiovolumesource)</code> | ScaleIO represents a ScaleIO persistent volume attached and mounted on Kubernetes nodes.<br/>__*Optional*__
**secret**?🔹 | <code>[k8s.SecretVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-secretvolumesource)</code> | Secret represents a secret that should populate this volume.<br/>__*Optional*__
**storageos**?🔹 | <code>[k8s.StorageOsVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-storageosvolumesource)</code> | StorageOS represents a StorageOS volume attached and mounted on Kubernetes nodes.<br/>__*Optional*__
**vsphereVolume**?🔹 | <code>[k8s.VsphereVirtualDiskVolumeSource](#opencdk8s-cdk8s-argo-rollout-k8s-vspherevirtualdiskvolumesource)</code> | VsphereVolume represents a vSphere volume attached and mounted on kubelets host machine.<br/>__*Optional*__



## struct VolumeAttachmentSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-volumeattachmentsource"></a>
...
Name | Type | Description 
-----|------|-------------
**inlineVolumeSpec**?🔹 | <code>[k8s.PersistentVolumeSpec](#opencdk8s-cdk8s-argo-rollout-k8s-persistentvolumespec)</code> | inlineVolumeSpec contains all the information necessary to attach a persistent volume defined by a pod's inline VolumeSource.<br/>__*Optional*__
**persistentVolumeName**?🔹 | <code>string</code> | Name of the persistent volume to attach.<br/>__*Optional*__



## struct VolumeAttachmentSpec 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-volumeattachmentspec"></a>
...
**source**🔹 | <code>[k8s.VolumeAttachmentSource](#opencdk8s-cdk8s-argo-rollout-k8s-volumeattachmentsource)</code> | Source represents the volume that should be attached.



## struct VolumeDevice 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-volumedevice"></a>
...
## struct VolumeMount 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-volumemount"></a>
...
## struct VolumeNodeAffinity 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-volumenodeaffinity"></a>
...
Name | Type | Description 
-----|------|-------------
**required**?🔹 | <code>[k8s.NodeSelector](#opencdk8s-cdk8s-argo-rollout-k8s-nodeselector)</code> | Required specifies hard node constraints that must be met.<br/>__*Optional*__



## struct VolumeProjection 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-volumeprojection"></a>
...
Name | Type | Description 
-----|------|-------------
**configMap**?🔹 | <code>[k8s.ConfigMapProjection](#opencdk8s-cdk8s-argo-rollout-k8s-configmapprojection)</code> | information about the configMap data to project.<br/>__*Optional*__
**downwardAPI**?🔹 | <code>[k8s.DownwardApiProjection](#opencdk8s-cdk8s-argo-rollout-k8s-downwardapiprojection)</code> | information about the downwardAPI data to project.<br/>__*Optional*__
**secret**?🔹 | <code>[k8s.SecretProjection](#opencdk8s-cdk8s-argo-rollout-k8s-secretprojection)</code> | information about the secret data to project.<br/>__*Optional*__
**serviceAccountToken**?🔹 | <code>[k8s.ServiceAccountTokenProjection](#opencdk8s-cdk8s-argo-rollout-k8s-serviceaccounttokenprojection)</code> | information about the serviceAccountToken data to project.<br/>__*Optional*__



## struct VsphereVirtualDiskVolumeSource 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-vspherevirtualdiskvolumesource"></a>
...
## struct Webhook 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-webhook"></a>
...
Name | Type | Description 
-----|------|-------------
**clientConfig**🔹 | <code>[k8s.WebhookClientConfig](#opencdk8s-cdk8s-argo-rollout-k8s-webhookclientconfig)</code> | ClientConfig holds the connection parameters for the webhook required.
**throttle**?🔹 | <code>[k8s.WebhookThrottleConfig](#opencdk8s-cdk8s-argo-rollout-k8s-webhookthrottleconfig)</code> | Throttle holds the options for throttling the webhook.<br/>__*Optional*__



## struct WebhookClientConfig 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-webhookclientconfig"></a>
...
**service**?🔹 | <code>[k8s.ServiceReference](#opencdk8s-cdk8s-argo-rollout-k8s-servicereference)</code> | `service` is a reference to the service for this webhook. Either `service` or `url` must be specified.<br/>__*Optional*__
**url**?🔹 | <code>string</code> | `url` gives the location of the webhook, in standard URL form (`scheme://host:port/path`).<br/>__*Optional*__



## struct WebhookThrottleConfig 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-webhookthrottleconfig"></a>
...
## struct WeightedPodAffinityTerm 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-weightedpodaffinityterm"></a>
...
Name | Type | Description 
-----|------|-------------
**podAffinityTerm**🔹 | <code>[k8s.PodAffinityTerm](#opencdk8s-cdk8s-argo-rollout-k8s-podaffinityterm)</code> | Required.
**weight**🔹 | <code>number</code> | weight associated with matching the corresponding podAffinityTerm, in the range 1-100.



## struct WindowsSecurityContextOptions 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-windowssecuritycontextoptions"></a>
...
## enum IoK8SApimachineryPkgApisMetaV1DeleteOptionsKind 🔹 <a id="opencdk8s-cdk8s-argo-rollout-k8s-iok8sapimachinerypkgapismetav1deleteoptionskind"></a>
